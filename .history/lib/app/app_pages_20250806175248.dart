...
class AppPages {
  static final routes = [
    GetPage(name: AppRoutes.home, page: () => const MainPage()),
    GetPage(name: AppRoutes.dungeon, page: () => const DungeonPage()),
    GetPage(name: AppRoutes.encounters, page: () => const EncountersPage()),
    GetPage(name: AppRoutes.turnMonitor, page: () => const TurnMonitorPage()),
  ];
}
