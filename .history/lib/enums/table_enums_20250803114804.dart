...
/// ========================================
/// ENUMS PARA TABELA 9.3 - TESOUROS POR NÍVEL
/// ========================================

/// Enum para representar níveis de tesouro (Tabela 9.3)
enum TreasureLevel {
  level1('1º Nível'),
  level2to3('2º-3º Nível'),
  level4to5('4º-5º Nível'),
  level6to7('6º-7º Nível'),
  level8to9('8º-9º Nível'),
  level10plus('10º ou mais');

  const TreasureLevel(this.description);
  final String description;

  /// Obtém a fórmula de PO para o nível
  String get goldFormula {
    switch (this) {
  ...
  /// Obtém a fórmula de PP para o nível
  String get silverFormula {
    switch (this) {
      case TreasureLevel.level1:
        return '1d6 x 100';
      case TreasureLevel.level2to3:
  ...
  /// Obtém a fórmula de Gemas para o nível
  String get gemsFormula {
    switch (this) {
      case TreasureLevel.level1:
        return '1 em 1d6\n1d3';
      case TreasureLevel.level2to3:
  ...
  /// Obtém a fórmula de Objetos de Valor para o nível
  String get valuableObjectsFormula {
    switch (this) {
      case TreasureLevel.level1:
        return '1 em 1d6\n1';
      case TreasureLevel.level2to3:
  ...
  /// Obtém a fórmula de Itens Mágicos para o nível
  String get magicItemsFormula {
    switch (this) {
      case TreasureLevel.level1:
        return '-';
      case TreasureLevel.level2to3:
