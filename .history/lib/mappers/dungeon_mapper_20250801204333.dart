  ...
  static String _buildRoomType(RoomGenerationDto dto) {
    switch (dto.type) {
      case RoomType.specialRoom:
        ...
        return description.isNotEmpty ? 'Sala Especial ($description)' : 'Sala Especial';
      case RoomType.trap:
      ...
      case RoomType.commonRoom:
        ...
        return description.isNotEmpty ? 'Sala Comum ($description)' : 'Sala Comum';
      case RoomType.monster:
        return 'Encontro';
      case RoomType.specialTrap:
        final description = dto.specialTrap?.description ?? '';
        return description.isNotEmpty ? 'Sala Armadilha Especial ($description)' : 'Sala Armadilha Especial';
    }
  }
