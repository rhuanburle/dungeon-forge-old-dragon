...
class DungeonMapper {
  ...
  static String _buildSpecialItem(RoomGenerationDto dto) {
    ...
    if (dto.foundItem == FoundItem.specialItems) {
      final specialItemDesc = dto.specialItem?.description ?? '';
      // Debug temporário
      if (specialItemDesc.isEmpty) {
        print('DEBUG: foundItem=${dto.foundItem.description}, specialItem=${dto.specialItem?.description}');
      }
      return specialItemDesc;
    }
    return '';
  }
