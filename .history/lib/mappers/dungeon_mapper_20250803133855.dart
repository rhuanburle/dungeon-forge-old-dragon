...
class DungeonMapper {
  ...
  static Room fromRoomDto(
    ...
    if (useTreasureByLevel && treasureLevel != null) {
      ...
      treasure = TreasureResolver.resolveByLevel(treasureLevel);
      specialTreasure = ''; // Fica vazio quando usa treasure by level
      magicItem = ''; // Fica vazio quando usa treasure by level
  ...
  static Map<String, String> _extractTreasureComponents(
    ...
    for (final line in lines) {
      if (line.contains('PO:') || line.contains('PP:')) {
        ...
        // Inclui gemas e objetos de valor no specialTreasure
        specialTreasure += (specialTreasure.isNotEmpty ? ' + ' : '') + line;
      } else if (line.contains('Itens Mágicos:')) {
        // Inclui itens mágicos (incluindo "Nenhum Item Mágico")
