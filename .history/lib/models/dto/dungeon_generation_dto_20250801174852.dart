...
class DungeonGenerationDto {
  ...
  String get fullObjective =>
      '${objective.description} ${target.description} ${targetStatus.description}';

  /// Constrói o rumor completo
  String get fullRumor =>
      '${rumorSubject.description} ${rumorAction.description} ${rumorLocation.description}';

  /// Resolve as referências de coluna no rumor
  String resolveRumorReferences(
      String occupantI, String occupantII, String leader) {
    return fullRumor
