...
class RoomGenerationDto {
  ...
  bool get hasTreasure => treasure != 'Nenhum';

  /// Obtém o tipo de sala como string descritiva
  String get typeDescription {
    if (type.contains('Sala Especial')) return 'Sala Especial';
    if (type.contains('Armadilha')) return 'Armadilha';
    if (type.contains('Sala Comum')) return 'Sala Comum';
    if (type.contains('Monstro')) return 'Encontro';
    if (type.contains('Sala Armadilha Especial')) return 'Sala Armadilha Especial';
    return type;
  }
