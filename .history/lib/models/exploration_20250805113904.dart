...
class AncestralDiscovery {
  ...
  final String? specificSize;
  final String? specificCondition;
  final String? specificPower;
  final String? specificSubtype;
...
class Civilization {
  ...
  final String attitudeAndThemes;
  ...
  const Civilization({
    ...
    required this.attitudeAndThemes,
  });
}
