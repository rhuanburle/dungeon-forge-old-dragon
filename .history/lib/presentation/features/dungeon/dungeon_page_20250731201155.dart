      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip:
                _autoRefresh ? 'Parar Auto-Refresh' : 'Iniciar Auto-Refresh',
            onPressed: () {
              setState(() {
                    ...
                    Expanded(
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            _buildInfoCard(
                                'Tipo', _dungeon.type, Icons.business),
                            _buildInfoCard('Construtor',
                                _dungeon.builderOrInhabitant, Icons.build),
                            _buildInfoCard(
                                'Status', _dungeon.status, Icons.circle),
                            _buildInfoCard(
                                'Objetivo', _dungeon.objective, Icons.flag),
                            _buildInfoCard(
                                'Localização', _dungeon.location, Icons.place),
                            _buildInfoCard(
                                'Entrada', _dungeon.entry, Icons.input),
                            _buildInfoCard('Número de Salas',
                                '${_dungeon.roomsCount}', Icons.grid_3x3),
                            _buildInfoCard(
                                'Ocupante I', _dungeon.occupant1, Icons.person),
                            _buildInfoCard('Ocupante II', _dungeon.occupant2,
                                Icons.people),
                            _buildInfoCard(
                                'Líder', _dungeon.leader, Icons.star),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (room.treasure.isNotEmpty &&
                      room.treasure != 'Nenhum (jogue novamente)')
