            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _buildRoomProperty('Cheiro', room.smell, Icons.smell),
                  ...
                  if (room.specialItem.isNotEmpty && room.specialItem != '—')
                    _buildRoomProperty('Item Especial', room.specialItem, Icons.star),
                  if (room.monster.isNotEmpty && room.monster != '—')
                    _buildRoomProperty('Monstro', room.monster, Icons.pets),
                  ...
                  if (room.specialTrap.isNotEmpty && room.specialTrap != '—')
                    _buildRoomProperty('Armadilha Especial', room.specialTrap, Icons.dangerous),
                  if (room.roomCommon.isNotEmpty && room.roomCommon != '—')
                    _buildRoomProperty('Sala Comum', room.roomCommon, Icons.room),
                  if (room.roomSpecial.isNotEmpty && room.roomSpecial != '—')
                    _buildRoomProperty('Sala Especial', room.roomSpecial, Icons.architecture),
                  if (room.roomSpecial2.isNotEmpty && room.roomSpecial2 != '—')
                    _buildRoomProperty('Sala Especial 2', room.roomSpecial2, Icons.castle),
                  ...
                  if (room.specialTreasure.isNotEmpty && room.specialTreasure != '—')
                    _buildRoomProperty('Tesouro Especial', room.specialTreasure, Icons.treasure),
                  if (room.magicItem.isNotEmpty && room.magicItem != '—')
                    _buildRoomProperty('Item Mágico', room.magicItem, Icons.auto_awesome),
                ],
              ),
            ),
            const SizedBox(height: 8),
