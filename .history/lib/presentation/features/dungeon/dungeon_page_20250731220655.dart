...
class _DungeonPageState extends State<DungeonPage> {
  ...
  String _buildMonsterText(Room room) {
    print('Building monster text for room ${room.index}: monster1="${room.monster1}", monster2="${room.monster2}"');
    if (room.monster2.isEmpty) {
      final result = room.monster1;
      print('  -> Single monster: $result');
      return result;
    } else {
      final result = '${room.monster1}, ${room.monster2}';
      print('  -> Two monsters: $result');
      return result;
    }
  }
