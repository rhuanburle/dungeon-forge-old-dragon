...
class _DungeonPageState extends State<DungeonPage> {
  ...
  static const Map<String, String> _trapDescriptions = {
    'Guilhotina Oculta': 'Uma lâmina afiada desce do teto quando ativada, causando dano letal.',
    'Fosso': 'Uma abertura no chão que leva a uma queda profunda, possivelmente com espinhos na base.',
    'Dardos Envenenados': 'Dardos são disparados das paredes, geralmente envenenados.',
    'Bloco que Cai': 'Um bloco pesado cai do teto quando a armadilha é ativada.',
    'Spray Ácido': 'Ácido é espirrado quando a armadilha é ativada, causando queimaduras.',
    'Poço de Água': 'Um poço que se enche de água, podendo afogar intrusos.',
    'Desmoronamento': 'Parte da estrutura desaba, bloqueando passagens ou soterrando vítimas.',
    'Teto Retrátil': 'O teto se move, revelando perigos ou criando obstáculos.',
    'Porta Secreta': 'Uma porta oculta que pode levar a áreas secretas ou ser uma armadilha.',
    'Alarme': 'Dispara um alerta que atrai monstros ou guardas para a área.',
    'Portal Dimensional': 'Um portal mágico que pode transportar para locais perigosos.',
  };
  ...
  void _generate() {
    ...
    final dungeon = generator.generate(
      ...
      customRoomCount: _customRoomCount,
      minRooms: _minRooms,
      maxRooms: _maxRooms,
    );
    setState(() {
