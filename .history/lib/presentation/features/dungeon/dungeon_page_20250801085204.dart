...
class _DungeonPageState extends State<DungeonPage> {
  ...
  static const Map<String, String> _trapDescriptions = {
    'Guilhotina Oculta':
        'Uma lâmina afiada desce do teto quando ativada. Causa 1d8 pontos de dano.',
    'Fosso':
        'Um buraco no chão que se abre revelando estacas afiadas. Causa 2d6 de dano aos que caírem. Há 1-2 chances em 1d6 de não haver estacas, mas sim uma passagem para um nível inferior da masmorra.',
    'Dardos Envenenados':
        '1d6 dardos são expelidos por buracos nas paredes. Causam 1d4 pontos de dano cada. O Mestre determina o efeito do veneno.',
    'Bloco que Cai':
        'Um bloco pesado cai do teto da masmorra quando ativado. Causa 1d10 de dano aos atingidos.',
    'Spray Ácido':
        'Ácido atinge todos até 6 metros da armadilha. Causa 1d4 de dano ácido aos atingidos.',
    'Poço de Água':
        'Poço de água suspeita no centro da sala, jorrando inexplicavelmente. Pode ser desde uma fonte inofensiva de água potável até água profana, benta ou envenenada.',
    'Desmoronamento':
        'Pedras soltas causaram a interrupção do caminho atual. Os jogadores podem remover todas as pedras (levando 3d6+10 turnos) ou dar meia volta e tentar outro caminho.',
    'Teto Retrátil':
        'O teto da sala desce até esmagar todos dentro da mesma. Um Desarmar Armadilhas precisa ser realizado por um Ladrão ou todos morrerão em até 1d8 turnos.',
    'Porta Secreta':
        'Porta escondida em algum ponto da sala. Só deve ser revelada caso algum personagem descubra sua existência. Caso contrário, a sala parece estar vazia.',
    'Alarme':
        'Dispara sinetas escondidas e amarradas com cordões por toda a extensão da sala. Alerta a todos num raio de 50 metros e impede que todos nesta área sejam surpreendidos pelos personagens.',
    'Portal Dimensional':
        'Portal que pode levar os personagens para outras salas aleatórias da mesma masmorra, acabando de vez com os planos de mapear corretamente o ambiente.',
  };
      ...
      appBar: AppBar(
        title: const Row(
          children: [
            ...
            SizedBox(width: 8),
            Text('Dungeon Forge - Old Dragon 2'),
          ],
        ),
