          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildInfoCard('Tipo', _dungeon.type, Icons.category),
                  _buildInfoCard(
                      'Construtor', _dungeon.builderOrInhabitant, Icons.build),
                  _buildInfoCard('Status', _dungeon.status, Icons.info),
                  _buildInfoCard('Objetivo', _dungeon.objective, Icons.track_changes),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (room.trap.isNotEmpty && room.trap != '—')
                      _buildRoomProperty('Armadilha', room.trap, Icons.dangerous),
