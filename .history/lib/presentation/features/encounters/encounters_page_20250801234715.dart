...
import 'package:dungeon_forge/services/encounter_generation_service.dart';
import 'package:dungeon_forge/utils/dice_roller.dart';
...
class _EncountersPageState extends State<EncountersPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Gerar Encontros'),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDropdownField(
              ...
              itemBuilder: (item) => Text('${item.description} (1d${item.diceSides})'),
            ),
            ...
            _buildDropdownField(
              ...
              itemBuilder: (item) => Text('${item.description} - ${item.levelRange}'),
            ),
  ...
  void _shareEncounter(EncounterGeneration encounter) {
    final text = encounter.generateDescriptionWithAdjustment(_quantityAdjustment);
