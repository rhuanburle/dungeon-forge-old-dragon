    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.settings, color: AppColors.textPrimary, size: 24),
          ...
          Divider(height: isMobile ? 16 : 24, color: AppColors.border),
          Expanded(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.person, color: AppColors.textPrimary, size: 24),
              SizedBox(width: isMobile ? 6 : 8),
              Text(
                'Encontro Gerado',
                style: Theme.of(context).textTheme.headlineSmall?.copyWith(
