...
class _ErmosPageState extends State<ErmosPage> {
        ...
        children: [
          ...
          Expanded(
            child: _currentResult == null
                ...
                : _buildExplorationResult(isMobile),
          ),
        ],
      ),
    );
  ...
  Widget _buildExplorationResult(bool isMobile) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          // Detalhes específicos baseados no tipo de descoberta
          if (_currentResult!.hasDiscovery &&
              _currentResult!.discoveryType != null)
            _buildDiscoveryDetails(isMobile),
        ],
      ),
    );
  }

  Widget _buildDiscoveryDetails(bool isMobile) {
    switch (_currentResult!.discoveryType!) {
      case DiscoveryType.ancestralDiscoveries:
        return _buildAncestralDiscoveryDetails(isMobile);
      case DiscoveryType.lairs:
        return _buildLairDetails(isMobile);
      case DiscoveryType.riversRoadsIslands:
        return _buildRiversRoadsIslandsDetails(isMobile);
      case DiscoveryType.castlesForts:
        return _buildCastleFortDetails(isMobile);
      case DiscoveryType.templesSanctuaries:
        return _buildTempleSanctuaryDetails(isMobile);
      case DiscoveryType.naturalDangers:
        return _buildNaturalDangerDetails(isMobile);
      case DiscoveryType.civilization:
        return _buildCivilizationDetails(isMobile);
      default:
        return const SizedBox.shrink();
    }
  }

  Widget _buildAncestralDiscoveryDetails(bool isMobile) {
    if (_ancestralDiscovery == null) return const SizedBox.shrink();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            _ancestralDiscovery!.description,
            style: TextStyle(
              color: AppColors.textSecondary,
              fontSize: isMobile ? 12 : 14,
            ),
  ...
  Widget _buildLairDetails(bool isMobile) {
    if (_lair == null) return const SizedBox.shrink();
  ...
  Widget _buildRiversRoadsIslandsDetails(bool isMobile) {
    if (_riversRoadsIslands == null) return const SizedBox.shrink();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            _riversRoadsIslands!.description,
            style: TextStyle(
              color: AppColors.textSecondary,
              fontSize: isMobile ? 12 : 14,
            ),
  ...
  Widget _buildCastleFortDetails(bool isMobile) {
    if (_castleFort == null) return const SizedBox.shrink();
  ...
  Widget _buildTempleSanctuaryDetails(bool isMobile) {
    if (_templeSanctuary == null) return const SizedBox.shrink();
  ...
  Widget _buildNaturalDangerDetails(bool isMobile) {
    if (_naturalDanger == null) return const SizedBox.shrink();
  ...
  Widget _buildCivilizationDetails(bool isMobile) {
    if (_civilization == null) return const SizedBox.shrink();
