...
class _ErmosPageState extends State<ErmosPage> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  IconButton(
                    icon: Icon(Icons.shield, color: AppColors.primaryLight),
                    tooltip: 'Gerar Guardião',
                    onPressed: _isGenerating ? null : _generateGuardian,
                  ),
                  IconButton(
  ...
  Widget _buildExplorationResult() {
    if (_currentResult == null)
      return _buildEmptyState(true); // Adicionar parâmetro isMobile
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(
                ...
                color: _currentResult!.hasDiscovery
                    ? AppColors.success
                    : AppColors.textSecondary,
                size: 24,
              ),
              ...
              Expanded(
                child: Text(
                  _currentResult!.hasDiscovery
                      ? 'Descoberta Encontrada!'
                      : 'Nada Encontrado',
                  style: TextStyle(
                    color: _currentResult!.hasDiscovery
                        ? AppColors.success
          ...
          if (_currentResult!.hasDiscovery &&
              _currentResult!.discoveryType != null) ...[
    ...
    return Column(
      ...
      children: [
        if (_ancestralDiscovery != null) ...[
          _buildDetailSection(
            'Tipo Ancestral',
            _ancestralDiscovery!.type.description,
          ),
          _buildDetailSection(
            'Condição',
    ...
    return Column(
      ...
      children: [
        if (_lair != null) ...[
          ...
          _buildDetailSection(
            'Rolagens',
            '1d6 para cada aspecto (Tabela 4.13)',
          ),
        ] else ...[
          Text(
            'Clique em "Gerar Detalhamento Completo" para ver todos os detalhes.',
    ...
    return Column(
      ...
      children: [
        if (_riversRoadsIslands != null) ...[
          ...
          _buildDetailSection(
            'Rolagens',
            '1d6 para cada aspecto (Tabela 4.25)',
          ),
        ] else ...[
          Text(
            'Clique em "Gerar Detalhamento Completo" para ver todos os detalhes.',
    ...
    return Column(
      ...
      children: [
        if (_castleFort != null) ...[
          ...
          _buildDetailSection(
            'Rolagens',
            '1d6 para cada aspecto (Tabela 4.30)',
          ),
        ] else ...[
          Text(
            'Clique em "Gerar Detalhamento Completo" para ver todos os detalhes.',
    ...
    return Column(
      ...
      children: [
        if (_templeSanctuary != null) ...[
          ...
          _buildDetailSection(
            'Rolagens',
            '1d6 para cada aspecto (Tabela 4.33)',
          ),
        ] else ...[
          Text(
            'Clique em "Gerar Detalhamento Completo" para ver todos os detalhes.',
    ...
    return Column(
      ...
      children: [
        if (_naturalDanger != null) ...[
          ...
          _buildDetailSection(
            'Rolagens',
            '1d6 para cada aspecto (Tabela 4.38)',
          ),
        ] else ...[
          Text(
            'Clique em "Gerar Detalhamento Completo" para ver todos os detalhes.',
    ...
    return Column(
      ...
      children: [
        if (_civilization != null) ...[
          ...
          const SizedBox(height: 8),
          // Exibir detalhes completos se disponíveis
          if (_civilization!.details.contains('Nível Tecnológico')) ...[
            _buildDetailSection('Nível Tecnológico', _extractField(_civilization!.details, 'Nível Tecnológico')),
            _buildDetailSection('Aparência', _extractField(_civilization!.details, 'Aparência')),
            _buildDetailSection('Alinhamento', _extractField(_civilization!.details, 'Alinhamento do Governo')),
            _buildDetailSection('Governante', _extractField(_civilization!.details, 'Governante')),
            _buildDetailSection('Raça Dominante', _extractField(_civilization!.details, 'Raça Dominante')),
            _buildDetailSection('Especial', _extractField(_civilization!.details, 'Especial')),
            _buildDetailSection('Atitude', _extractField(_civilization!.details, 'Atitude com Visitantes')),
            _buildDetailSection('Tema Povoado', _extractField(_civilization!.details, 'Tema (Povoado/Aldeia/Vila)')),
            _buildDetailSection('Tema Cidade', _extractField(_civilization!.details, 'Tema (Cidade/Metrópole)')),
          ] else ...[
            _buildDetailSection(
              'Rolagens',
              '1d6 para cada aspecto (Tabela 4.39)',
            ),
          ],
        ] else ...[
          Text(
    ...
    if (_currentResult?.discoveryType != null) {
      switch (_currentResult!.discoveryType!) {
        ...
        case DiscoveryType.lairs:
          ...
          break;
        case DiscoveryType.riversRoadsIslands:
          _riversRoadsIslands = _explorationService
              .generateDetailedRiversRoadsIslands();
          break;
        case DiscoveryType.castlesForts:
  ...
  void _generateGuardian() async {
    ...
    _guardian = _explorationService.generateRandomGuardian();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.shield, color: AppColors.primaryLight, size: 20),
              const SizedBox(width: 8),
              Text(
                'Guardião Gerado',
                style: TextStyle(
          ...
          _buildDetailSection('Tipo', _guardian!.type.description),
          _buildDetailSection('Descrição', _guardian!.description),
          const SizedBox(height: 8),
          Text(
            'Detalhes:',
            style: TextStyle(
