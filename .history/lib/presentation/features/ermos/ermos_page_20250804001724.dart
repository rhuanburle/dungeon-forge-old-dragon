      ...
      children: [
        if (_civilization != null) ...[
          ...
          if (_civilization!.details.contains('Nível Tecnológico')) ...[
            _buildDetailSection(
              'Nível Tecnológico',
              _extractField(_civilization!.details, 'Nível Tecnológico'),
            ),
            _buildDetailSection(
              'Aparência',
              _extractField(_civilization!.details, 'Aparência'),
            ),
            _buildDetailSection(
              'Alinhamento',
              _extractField(_civilization!.details, 'Alinhamento do Governo'),
            ),
            _buildDetailSection(
              'Governante',
              _extractField(_civilization!.details, 'Governante'),
            ),
            _buildDetailSection(
              'Raça Dominante',
              _extractField(_civilization!.details, 'Raça Dominante'),
            ),
            _buildDetailSection(
              'Especial',
              _extractField(_civilization!.details, 'Especial'),
            ),
            _buildDetailSection(
              'Atitude',
              _extractField(_civilization!.details, 'Atitude com Visitantes'),
            ),
            _buildDetailSection(
              'Tema Povoado',
              _extractField(
                _civilization!.details,
                'Tema (Povoado/Aldeia/Vila)',
              ),
            ),
            _buildDetailSection(
              'Tema Cidade',
              _extractField(_civilization!.details, 'Tema (Cidade/Metrópole)'),
            ),
          ] else ...[
            _buildDetailSection(
              'Rolagens',
