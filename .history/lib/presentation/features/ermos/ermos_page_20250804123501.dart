...
class _ErmosPageState extends State<ErmosPage> {
  ...
  String _getRuinTypeDetails() {
    // Por enquanto, retorna um placeholder. Será implementado quando tivermos acesso aos dados específicos
    return 'Tipo de ruína (Tabela 4.5)';
  }

  String _getRuinSizeDetails() {
    return 'Tamanho da ruína (Tabela 4.5)';
  }

  String _getRuinDefenseDetails() {
    return 'Defesas da ruína (Tabela 4.5)';
  }

  String _getRelicTypeDetails() {
    return 'Tipo de relíquia (Tabela 4.6)';
  }

  String _getRelicConditionDetails() {
    return 'Condição da relíquia (Tabela 4.7)';
  }

  String _getObjectTypeDetails() {
    return 'Tipo de objeto (Tabela 4.8)';
  }

  String _getObjectSubtypeDetails() {
    return 'Subcategoria do objeto (Tabela 4.8)';
  }

  String _getVestigeTypeDetails() {
    return 'Tipo de vestígio (Tabela 4.9)';
  }

  String _getVestigeDetailDetails() {
    return 'Detalhe específico (Tabela 4.10)';
  }

  String _getOssuaryTypeDetails() {
    return 'Tipo de ossada (Tabela 4.11)';
  }

  String _getOssuarySizeDetails() {
    return 'Tamanho da ossada (Tabela 4.11)';
  }

  String _getMagicalItemTypeDetails() {
    return 'Tipo de item mágico (Tabela 4.12)';
  }

  String _getMagicalItemPowerDetails() {
    return 'Poder do item mágico (Tabela 4.12)';
  }
}
