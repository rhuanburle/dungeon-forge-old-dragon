...
class _ErmosPageState extends State<ErmosPage> {
  ...
  String _getRuinDefenseDetails() {
    return _ancestralDiscovery?.specificSubtype ?? 'Defesas da ruína (Tabela 4.5)';
  }
  ...
  String _getRelicConditionDetails() {
    return _ancestralDiscovery?.specificCondition ?? 'Condição da relíquia (Tabela 4.7)';
  }
  ...
  String _getObjectSubtypeDetails() {
    return _ancestralDiscovery?.specificSubtype ?? 'Subcategoria do objeto (Tabela 4.8)';
  }
  ...
  String _getVestigeDetailDetails() {
    return _ancestralDiscovery?.specificSubtype ?? 'Detalhe específico (Tabela 4.10)';
  }
  ...
  String _getOssuarySizeDetails() {
    return _ancestralDiscovery?.specificSize ?? 'Tamanho da ossada (Tabela 4.11)';
  }

  String _getMagicalItemTypeDetails() {
    return _ancestralDiscovery?.specificType ?? 'Tipo de item mágico (Tabela 4.12)';
  }

  String _getMagicalItemPowerDetails() {
    return _ancestralDiscovery?.specificPower ?? 'Poder do item mágico (Tabela 4.12)';
  }
}
