...
class _ErmosPageState extends State<ErmosPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (_currentResult!.discoveryType == DiscoveryType.ancestralDiscoveries) ...[
            const SizedBox(height: 12),
            Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Descobertas ancestrais englobam todas as coisas que estão há muito tempo perdidas ou esquecidas, podendo ter pertencido ou não a antigas civilizações.\n\n'
                    '• Ruínas: construções de grande porte há muito tempo abandonadas pelos seus construtores originais. Podem ter sido ocupadas por criaturas invasoras.\n\n'
                    '• Relíquias: bens de relativo valor comercial de eras ancestrais abandonados pelo tempo. Com uma dose de sorte, tesouros podem ser encontrados dentre as relíquias.\n\n'
                    '• Objetos: ao contrário das relíquias, os objetos não possuíam valor por serem itens de uso comum, do dia a dia.\n\n'
                    '• Vestígios: menores e menos impactantes que as ruínas, vestígios são pedaços de construções ou estruturas ancestrais que sobreviveram à passagem do tempo.\n\n'
                    '• Ossadas: habitantes de tempos ancestrais também deixam suas marcas no tempo com o que sobraram de seus corpos.\n\n'
                    '• Itens Mágicos: a magia dos tempos ancestrais pode chegar até os dias de hoje por meio de conhecimento e de itens mágicos há muito perdidos.',
  ...
  Widget _buildLairDetails() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildInfoCard('Informações do Covil', Icons.home, [
  ...
  Widget _buildRiversRoadsIslandsDetails() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildInfoCard('Informações da Descoberta', Icons.water, [
  ...
  Widget _buildTempleSanctuaryDetails() {
    ...
    return Column(
      ...
      children: [
        // Card de Informações Básicas
        _buildInfoCard('Informações do Templo', Icons.temple_buddhist, [
  ...
  Widget _buildCivilizationDetails() {
    ...
    return Column(
      ...
      children: [
        // Card de Informações Básicas
        _buildInfoCard('Informações da Civilização', Icons.location_city, [
