      ...
      children: [
        ...
        Row(
          children: [
            ...
            Expanded(child: Text('A (Criado por...)', style: TextStyle(fontWeight: FontWeight.bold))),
            Expanded(child: Text('B (Para...)', style: TextStyle(fontWeight: FontWeight.bold))),
            Expanded(child: Text('C (Um(a)...)', style: TextStyle(fontWeight: FontWeight.bold))),
          ],
        ),
