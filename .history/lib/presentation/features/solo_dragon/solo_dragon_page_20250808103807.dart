        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildRoomDetail('Portas', '${room.doorsRoll} (d6+d6) — ${room.doors}'),
              if (room.contentTriggeredFromDoors) ...[
                _buildRoomDetail('Conteúdo', '${room.contentRoll} (d6+d6) — ${room.content}'),
                if (room.treasureTriggeredFromContent)
                  _buildRoomDetail('Tesouro', '${room.treasureRoll} (2d6) — ${room.treasure}'),
                if (room.trapTriggeredFromContent) ...[
                  _buildRoomDetail('Armadilha', '${room.trapRoll} (d6+d6) — ${room.trap}'),
                  if (room.encounterTriggeredFromTrap)
                    _buildRoomDetail('Encontro', '${room.encounterRoll} (d6+d6) — ${room.encounter}'),
                ],
              ],
            ],
          ),
