...
class _SoloDragonPageState extends State<SoloDragonPage> {
          ...
          children: [
            Row(
              children: [
                ...
                const Spacer(),
                Text('${room.roomTypeRoll} (2d6)', style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
              ],
            ),
            const SizedBox(height: 6),
            _buildRoomSummaryRow('Portas', '${room.doorsRoll} — ${_dashIfEmpty(room.doors)}'),
  ...
  String _dashIfEmpty(String? value) => (value == null || value.isEmpty) ? '—' : value;
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              _buildRoomDetail('Tipo', '${room.roomTypeRoll} (2d6) — ${room.type}'),
              _buildRoomDetail('Portas', '${room.doorsRoll} (d6+d6) — ${_dashIfEmpty(room.doors)}'),
