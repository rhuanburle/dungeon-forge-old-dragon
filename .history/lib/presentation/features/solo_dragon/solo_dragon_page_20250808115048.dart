              ...
              child: Row(
                children: [
                  ...
                  TextButton.icon(
                    ...
                    icon: const Icon(Icons.visibility, size: 16, color: Colors.amber),
                    label: const Text(
                      'Ver A5.7',
        ...
        return AlertDialog(
          ...
          title: Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text('Tabela A5.5 - Encontros', style: TextStyle(color: Colors.white)),
              const Spacer(),
              TextButton.icon(
                onPressed: () => setState(() {}),
          ...
          content: SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Use 1d6 para dezena e 1d6 para unidade (11..66).', style: TextStyle(color: Colors.white70)),
                  const SizedBox(height: 12),
                  for (final r in all)
                    Padding(
  ...
  void _showFinalMysteryTables() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: AppColors.surfaceLight,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        title: const Text('Câmara Final (A5.7)', style: TextStyle(color: Colors.white)),
