          ...
          children: [
            ...
            if (room.trapTriggeredFromContent && room.trap.isNotEmpty)
              Padding(
                ...
                child: Text(
                  _service.getTrapDetail(room.trap),
          ...
          title: Row(
            children: [
              ...
              TextButton.icon(
                ...
                label: const Text('Rolar 1d6+1d6', style: TextStyle(color: Colors.white)),
              ),
            ],
          ),
          content: SizedBox(
          ...
          builder: (context, setStateDialog) {
            ...
            return SizedBox(
              ...
              child: Column(
                ...
                children: [
                  const Text(
                    'Role 1d6 na Subtabela A para saber se a masmorra deu certo (B/C/D),\n'
                    'depois role 1d6 na subtabela indicada para complementar o evento final.',
                    style: TextStyle(color: Colors.white70),
                  ),
                  const SizedBox(height: 12),
                  ElevatedButton.icon(
                    onPressed: () {
                      final r = _service.rollFinalChamber();
                      setStateDialog(() {
                        result = r;
                      });
                    },
                    icon: const Icon(Icons.casino, size: 16),
                    label: const Text('Rolar Câmara Final (1d6 + 1d6)'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: AppColors.primary,
                      foregroundColor: Colors.white,
                    ),
                  ...
                  if (result != null)
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Subtabela A: ${result!.aRoll} — ${result!.aText}',
                              style: const TextStyle(color: Colors.white)),
                          const SizedBox(height: 6),
                          Text('Subtabela ${result!.subTable}: ${result!.subRoll} — ${result!.subText}',
                              style: const TextStyle(color: Colors.white)),
                        ],
                      ),
                    ),
