...
class MercenaryState {
  ...
  const MercenaryState.present({required this.costMultiplier});
}
...
class _SoloDragonPageState extends State<SoloDragonPage> {
  ...
  // Tipo simples para o estado do mercenário opcional — classe movida para top-level
  ...
  Widget _buildHeader() {
    return Row(
      children: [
        ...
        Row(
          children: [
            const Text('Opcional', style: TextStyle(color: Colors.white70)),
            Switch(
              value: _optionalMode,
              activeColor: AppColors.primary,
              onChanged: (v) => setState(() => _optionalMode = v),
            ),
          ],
        ),
        ActionButton(
        ...
        children: [
          ...
          if (_mercenary != null)
            Padding(
              ...
              child: Text(
                'Mercenário presente (custo x${_mercenary!.costMultiplier}). Iniciativa e ações próprias (Livro I).',
          ...
          Padding(
            ...
            child: Text(
              'Turnos: $_dungeonTurns • Chance de encontro a cada 2 turnos — básica 1 em 1d6; barulho/luz 1–2 em 1d6.',
              style: TextStyle(color: AppColors.textSecondary),
            ),
          ),
        ],
