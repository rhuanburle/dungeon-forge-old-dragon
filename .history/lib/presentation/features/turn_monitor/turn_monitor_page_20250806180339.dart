...
class _TurnMonitorPageState extends State<TurnMonitorPage> {
  ...
  final TextEditingController _groupMovementController = TextEditingController();
  final TextEditingController _movementPerTurnController = TextEditingController();
  ...
  final TextEditingController _encounterNotesController = TextEditingController();
  ...
  void _addRandomEncounter() {
    final hasLight = _service.groupData.hasTorch || _service.groupData.hasLantern;
  ...
  void _testDoorAction(DoorType doorType) {
    ...
    switch (doorType) {
      ...
      case DoorType.secret:
        ...
        break;
      default:
        result = const TurnResult(success: true, description: 'Porta aberta normalmente');
        break;
    }
            ...
            Row(
              ...
              children: [
                ...
                ActionButton(
                  ...
                  text: _showGroupDataForm ? 'Ocultar' : 'Editar',
                  icon: _showGroupDataForm ? Icons.visibility_off : Icons.edit,
                ),
              ],
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: Text('Exploração: ${_service.explorationTurns} turnos'),
                ),
                Expanded(
                  child: Text('Descanso: ${_service.restTurns} turnos'),
                ),
              ],
            ),
            if (_service.groupData.isExhausted)
              const Text(
                '⚠️ GRUPO EXAUSTO - Todos os testes como difícil',
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                ActionButton(
                  onPressed: () => _addTurnWithAction(ActionType.moveExploration),
                ...
                ActionButton(
                  onPressed: () => _addTurnWithAction(ActionType.search),
                  text: 'Procurar',
                  icon: Icons.search,
                ),
                ActionButton(
                  onPressed: () => _addTurnWithAction(ActionType.searchTraps),
                  text: 'Procurar Armadilhas',
                  icon: Icons.warning,
                ),
                ActionButton(
                  onPressed: () => _addTurnWithAction(ActionType.searchSecret),
                  text: 'Procurar Secreta',
                  icon: Icons.hide_source,
                ),
                ActionButton(
                  onPressed: () => _addTurnWithAction(ActionType.combat),
                  text: 'Combater',
                  icon: Icons.gps_fixed,
                ),
                ActionButton(
                  onPressed: () => _addTurnWithAction(ActionType.castSpell),
                  text: 'Conjurar Magia',
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    if (turn.isMoving)
                      const Icon(Icons.directions_walk, color: Colors.cyan, size: 16),
                    if (turn.isDoorAction)
                      const Icon(Icons.door_front_door, color: Colors.purple, size: 16),
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  'Encontros (${_service.encounters.length})',
                  style: const TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.white,
