          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_hasTorch) Text('Turnos restantes: $_torchTurns'),
                    ],
                  ),
                ),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_hasLantern) Text('Turnos restantes: $_lanternTurns'),
                    ],
                  ),
                ),
              ],
            ...
            Row(
              children: [
                Expanded(
                  child: Text(
                    'Exploração: ${_service.explorationTurns} turnos',
                  ),
                ),
                Expanded(child: Text('Descanso: ${_service.restTurns} turnos')),
              ],
            ),
