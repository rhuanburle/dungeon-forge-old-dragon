                            ...
                            children: [
                              ...
                              if (_hasTorch)
                                Text(
                                  ...
                                  style: TextStyle(
                                    color: _torchTurns <= 2 ? Colors.red : Colors.white,
                                    fontWeight: _torchTurns <= 2 ? FontWeight.bold : FontWeight.normal,
                                  ),
                                ),
                            ],
                          ),
                            ...
                            children: [
                              ...
                              if (_hasLantern)
                                Text(
                                  ...
                                  style: TextStyle(
                                    color: _lanternTurns <= 6 ? Colors.red : Colors.white,
                                    fontWeight: _lanternTurns <= 6 ? FontWeight.bold : FontWeight.normal,
                                  ),
                                ),
                            ],
                          ),
