            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  if (room.smell.isNotEmpty && room.smell != 'Sem cheiro especial')
                    _buildRoomProperty(
                      'Cheiro',
                      room.smell,
                      Icons.smell,
                    ),
                  if (room.sound.isNotEmpty && room.sound != 'Nenhum som especial')
                    _buildRoomProperty(
                      'Som',
                      room.sound,
                      Icons.volume_up,
                    ),
                  if (room.item.isNotEmpty && room.item != 'Completamente vazia')
                    _buildRoomProperty(
                      'Itens',
                      room.item,
                      Icons.inventory,
