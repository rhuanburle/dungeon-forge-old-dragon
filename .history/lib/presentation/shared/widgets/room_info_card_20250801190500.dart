  ...
  Widget _buildEnvironmentInfo(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (room.specialItem.isNotEmpty) _buildInfoRow('Itens Especiais', room.specialItem),
      ],
    );
  }
  ...
  Widget _buildTrapInfo(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (room.specialTrap.isNotEmpty) _buildInfoRow('Armadilha Especial', room.specialTrap),
      ],
    );
  }
  ...
  Widget _buildTreasureInfo(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (room.specialTreasure.isNotEmpty) _buildInfoRow('Tesouro Especial', room.specialTreasure),
        if (room.magicItem.isNotEmpty) _buildInfoRow('Item Mágico', room.magicItem),
      ],
    );
  }
