...
import 'tables/occupant_table.dart';
import 'tables/rumor_table.dart';
...
class DungeonDataService {
  ...
  DungeonGenerationDto generateDungeonData() {
    ...
    final builderOrInhabitant = DungeonTable9_1.getColumn2(col2Roll);
    ...
    final occupantI = OccupantTable.getColumn10(col10Roll);
    final occupantII = OccupantTable.getColumn11(col11Roll);
    final leader = OccupantTable.getColumn12(col12Roll);
    final rumorSubject = RumorTable.getColumn13(col13Roll);
    final rumorAction = RumorTable.getColumn14(col14Roll);
    final rumorLocation = RumorTable.getColumn15(col15Roll);
