...
class DungeonDataService {
  ...
  String _getOccupant(
    ...
    if (!useEncounterTables || terrainType == null || difficultyLevel == null || partyLevel == null) {
      final dungeonTable = _tableManager.dungeonTable;
    ...
    try {
      ...
      final result = _getResultFromTable(encounterTable, partyLevel, encounterRoll);
  ...
  dynamic _getTableForTerrain(TerrainType terrain) {
    switch (terrain) {
      ...
      case TerrainType.humans:
        return _tableManager.humansTable;
      default:
        return _tableManager.subterraneanEncounterTable;
    }
  }
  ...
  dynamic _getResultFromTable(dynamic table, PartyLevel partyLevel, int roll) {
    ...
    try {
      ...
      return table.getColumnValue(1, roll);
    }
  }
