...
class DungeonDataService {
  ...
  void regenerateOccupants({
    ...
    // Se não há dados atuais, inicializa com dados básicos
    if (_currentDungeonData == null) {
      // Usa valores padrão para inicializar
      final dungeonTable = _tableManager.dungeonTable;
      _currentDungeonData = DungeonGenerationDto(
        type: DungeonType.castle,
        builderOrInhabitant: DungeonBuilder.humans,
        ...
        location: DungeonLocation.underground,
        entry: DungeonEntry.secret,
        sizeFormula: '2d6',
        occupantI: '',
        occupantII: '',
        leader: '',
        rumorSubject: dungeonTable.getColumn13(1),
        rumorAction: dungeonTable.getColumn14(1),
        rumorLocation: dungeonTable.getColumn15(1),
      );
    }
  ...
  /// Obtém os dados atuais da masmorra (para regeneração de ocupantes)
  DungeonGenerationDto? get currentDungeonData => _currentDungeonData;
}
