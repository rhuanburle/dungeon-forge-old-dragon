...
class DungeonGenerator {
  ...
  Dungeon generate({required int level, required String theme}) {
    ...
    final roomsCount = _extractRoomsCount(col9Raw);
  ...
  Room _generateRoom(int index, int level) {
    ...
    final treasure = _roomCol13[DiceRoller.roll(2, 6) - 2];
    final specialTreasure = _roomCol14[DiceRoller.roll(2, 6) - 2];
    final magicItem = _roomCol15[DiceRoller.roll(2, 6) - 2];
  ...
  int _extractRoomsCount(String raw) {
    ...
    return DiceRoller.rollFormula(formula);
  }
  ...
  static const _col4 = [
    'Defender artefato sendo procurado',
    'Defender artefato sendo procurado',
    'Esconder livro destruído',
    'Esconder livro destruído',
    'Proteger espada desaparecido',
    'Proteger espada desaparecido',
    'Guardar gema roubado',
    'Guardar gema roubado',
    'Vigiar elmo intacto',
    'Vigiar elmo intacto',
    'Isolar tesouro soterrado',
    'Isolar tesouro soterrado',
  ];
