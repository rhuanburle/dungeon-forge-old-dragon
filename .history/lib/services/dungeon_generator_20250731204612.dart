...
class DungeonGenerator {
  ...
  Dungeon generate({
    ...
    return Dungeon(
      ...
      occupant2: col11,
      leader: col12,
      rumor1: _buildRumor(col13, col11, col10, col12),
      rumor2: _buildRumor(col14, col11, col10, col12),
      rumor3: _buildRumor(col15, col11, col10, col12),
      rooms: rooms,
    );
  }
  ...
  String _buildRumor(String template, String col11, String col10, String col12) {
    return template
