...
class DungeonGenerator {
  ...
  Room _generateRoom(int index, int level, {String? occupantI, String? occupantII}) {
    ...
    var monster = _roomCol10[DiceRoller.roll(2, 6) - 2];
    ...
    if (occupantI != null) {
      monster = monster.replaceAll('Ocupante I', occupantI);
    }
    if (occupantII != null) {
      monster = monster.replaceAll('Ocupante II', occupantII);
    }
    ...
    if (specialTreasure.contains('d') || specialTreasure.contains('Jogue Novamente')) {
