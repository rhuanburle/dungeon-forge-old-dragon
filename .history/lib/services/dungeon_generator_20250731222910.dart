...
class DungeonGenerator {
  ...
  Room _generateRoom(int index, int level,
    ...
    // Processa tesouro baseado na tabela correta
    final treasureRoll = DiceRoller.roll(2, 6);
    var treasure = '';
    var specialTreasure = '';
    var magicItem = '';
    ...
    if (treasureRoll <= 3) {
      ...
      final specialRoll = DiceRoller.roll(2, 6);
      if (specialRoll <= 2) {
    ...
    if (treasure == 'Item Mágico' || specialTreasure.contains('Item Mágico')) {
      final magicRoll = DiceRoller.roll(2, 6);
      if (magicRoll <= 3) {
