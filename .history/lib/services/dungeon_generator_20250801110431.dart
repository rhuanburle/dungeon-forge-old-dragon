...
class DungeonGenerator {
  ...
  String _resolveColumnReference(String text, int col7Roll, int col8Roll, int col9Roll, 
      int col10Roll, int col11Roll, int col12Roll, int col13Roll, int col14Roll, int col15Roll) {
    if (text.contains('(coluna 7)')) {
      return text.replaceAll('(coluna 7)', _getCol7Result(col7Roll));
    }
    if (text.contains('(coluna 8)')) {
      return text.replaceAll('(coluna 8)', _getCol8Result(col8Roll));
    }
    ...
    if (text.contains('(coluna 11)')) {
      return text.replaceAll('(coluna 11)', _getCol11Result(col11Roll));
    }
    if (text.contains('(coluna 12)')) {
      return text.replaceAll('(coluna 12)', _getCol12Result(col12Roll));
    }
    if (text.contains('(coluna 13)')) {
      return text.replaceAll('(coluna 13)', _getCol13Result(col13Roll));
    }
  ...
  String _getCol14Result(int roll) {
    ...
    if (roll <= 9) return '1d6 x 1.000 PP + 1d6 x 200 PO + 1d6 Gemas + 1d4 Objetos de Valor';
    if (roll <= 11) return '1d6 x 1.000 PP + 1d6 x 200 PO + 1d6 Gemas + Item Mágico';
