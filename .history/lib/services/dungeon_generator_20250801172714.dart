...
class DungeonGenerator {
  ...
  Dungeon generate({
    ...
    final locationEntry =
        DungeonLocationTable.entries[DiceRoller.roll(2, 6) - 2];
    ...
    for (int i = 1; i <= roomsCount; i++) {
      rooms.add(_generateRoom(i, level,
          occupantI: occupantEntry.occupant1,
          occupantII: occupantEntry.occupant2));
    }
    ...
    return Dungeon(
      ...
      rumor1: rumorEntry.buildRumor(occupantEntry.occupant1,
          occupantEntry.occupant2, occupantEntry.leader),
      rooms: rooms,
    );
  }
