...
import 'tables/dungeon_table_service.dart';
import 'tables/room_table_service.dart';
...
class DungeonGenerator {
  ...
  Room _buildRoomFromData(int index, RoomTableDto data) {
    ...
    final resolvedTreasure = TreasureResolverService.resolveTreasure(data.treasure);
    final resolvedSpecialTreasure = TreasureResolverService.resolveTreasure(data.specialTreasure);
    final resolvedMagicItem = TreasureResolverService.resolveMagicItem(data.magicItem);
  ...
  String _buildRumor(DungeonTableDto data) {
    final rumor = '${data.rumorSubject} ${data.rumorAction} ${data.rumorContext}';
