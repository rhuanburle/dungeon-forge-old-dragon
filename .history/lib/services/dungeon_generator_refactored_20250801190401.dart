...
class DungeonGeneratorRefactored {
  ...
  const DungeonGeneratorRefactored({
    DungeonDataService? dungeonDataService,
    RoomGenerationService? roomGenerationService,
    RoomSizeCalculator? roomSizeCalculator,
  }) : _dungeonDataService = dungeonDataService ?? const DungeonDataService(),
       _roomGenerationService = roomGenerationService ?? const RoomGenerationService(),
       _roomSizeCalculator = roomSizeCalculator ?? const RoomSizeCalculator();
