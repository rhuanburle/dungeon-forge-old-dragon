...
class DungeonGeneratorRefactored {
  ...
  Dungeon generate({
    ...
    final finalUseTreasureByLevel = useTreasureByLevel || autoUseTreasureByLevel;
    ...
    final roomsCount = customRoomCount ?? _calculateRoomCount(level);
    ...
    return Dungeon(
      ...
      theme: theme,
      rooms: rooms,
      terrainType: terrainType?.description ?? 'Não especificado',
      difficultyLevel: difficultyLevel?.description ?? 'Não especificado',
    );
  }
