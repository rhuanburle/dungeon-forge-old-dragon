...
class DungeonGeneratorRefactored {
  ...
  void updateRoomOccupants(Dungeon dungeon) {
    final dungeonData = _dungeonDataService._currentDungeonData;
    ...
    for (int i = 0; i < dungeon.rooms.length; i++) {
      ...
      // Atualiza apenas os campos de ocupantes na sala existente
      dungeon.rooms[i] = room.copyWith(
        occupant: updatedRoom.occupant,
        occupantI: updatedRoom.occupantI,
        occupantII: updatedRoom.occupantII,
