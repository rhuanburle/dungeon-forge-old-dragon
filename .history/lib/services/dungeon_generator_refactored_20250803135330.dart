...
class DungeonGeneratorRefactored {
  ...
  Dungeon generate({
    ...
    // Auto-configura o nível de tesouro baseado no PartyLevel se useTreasureByLevel é true
    TreasureLevel? finalTreasureLevel = treasureLevel;
    if (useTreasureByLevel && treasureLevel == null && partyLevel != null) {
      finalTreasureLevel = _mapPartyLevelToTreasureLevel(partyLevel);
    }
  ...
  /// Mapeia PartyLevel para TreasureLevel
  TreasureLevel _mapPartyLevelToTreasureLevel(PartyLevel partyLevel) {
    switch (partyLevel) {
      case PartyLevel.beginners:
        return TreasureLevel.level1;
      case PartyLevel.heroic:
        return TreasureLevel.level2to3;
      case PartyLevel.advanced:
        return TreasureLevel.level6to7;
    }
  }
}
