...
class DungeonMapRenderer {
  ...
  Map<String, dynamic> buildGridWithPositions(Dungeon dungeon) {
    ...
    for (int i = 1; i < dungeon.roomsCount; i++) {
      bool placed = false;
      int attempts = 0;
      const maxAttempts = 200; // Aumentado para mais tentativas
      ...
      while (!placed && attempts < maxAttempts) {
        ...
        if (!placed && attempts > maxAttempts / 2) {
          ...
          for (int dir = 0; dir < 4 && !placed; dir++) {
            ...
            switch (dir) {
              case 0: x -= smallerW ~/ 2; y -= (smallerH + 1); break;
              case 1: x -= smallerW ~/ 2; y += 1; break;
              case 2: x -= (smallerW + 1); y -= smallerH ~/ 2; break;
              case 3: x += 1; y -= smallerH ~/ 2; break;
            }
