...
class EncounterGenerationService {
  ...
  int _rollForTableReference(TableReference reference) {
    switch (reference) {
      ...
      case TableReference.extraplanarTableIII:
        return _diceRoller.rollSingleDie(DiceType.d8); // 1d8 para extraplanar
      default:
  ...
  int _getDefaultQuantityForMonster(MonsterType monsterType) {
    ...
    switch (monsterType) {
      ...
      // Casos especiais com expressões complexas
      case MonsterType.hydra:
        return _diceRoller.rollComplexDice('5+1d3'); // 5+1d3 cabeças (Hidra)
      case MonsterType.hydra5Heads:
        return _diceRoller.rollComplexDice('5+1d3'); // 5+1d3 cabeças
      case MonsterType.hydra8Heads:
        return _diceRoller.rollComplexDice('8+1d4'); // 8+1d4 cabeças
