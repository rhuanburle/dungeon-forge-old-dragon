...
class ExplorationService {
  ...
  RiversRoadsIslands generateDetailedRiversRoadsIslands() {
    ...
    final type = _getRiversRoadsIslandsType(typeRoll);
  ...
  NaturalDanger generateDetailedNaturalDanger() {
    ...
    final type = _getNaturalDangerType(TerrainType.forests); // Usar terreno padrão
...
''';
  ...
  ObjectType _getObjectType(int roll) {
    switch (roll) {
      ...
      case 2: return ObjectType.clothing;
  ...
  MagicalItemType _getMagicalItemType(int roll) {
    switch (roll) {
      ...
      case 2: return MagicalItemType.armor;
  ...
  LairOccupation _getLairOccupation(int roll) {
    switch (roll) {
      case 1: return LairOccupation.emptyAbandoned;
  ...
  RiversRoadsIslandsType _getRiversRoadsIslandsType(int roll) {
    switch (roll) {
