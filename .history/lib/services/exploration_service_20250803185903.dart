...
class ExplorationService {
  ...
  AncestralDiscovery generateAncestralDiscovery() {
    ...
    final description = _getAncestralDescription(type, condition, material, state, guardian);
    final details = _getAncestralDetails(type, condition, material, state, guardian);
  ...
  Ruin generateRuin() {
    ...
    final description = _getRuinDescription(type);
    final details = _getRuinDetails(type);
  ...
  Relic generateRelic() {
    ...
    final description = _getRelicDescription(type);
    final details = _getRelicDetails(type);
  ...
  Object generateObject() {
    ...
    final description = _getObjectDescription(type);
    final details = _getObjectDetails(type);
  ...
  Vestige generateVestige() {
    ...
    final description = _getVestigeDescription(type);
    final details = _getVestigeDetails(type);
  ...
  Ossuary generateOssuary() {
    ...
    final description = _getOssuaryDescription(type);
    final details = _getOssuaryDetails(type);
  ...
  MagicalItem generateMagicalItem() {
    ...
    final description = _getMagicalItemDescription(type);
    final details = _getMagicalItemDetails(type);
  ...
  Lair generateLair() {
    ...
    final description = _getLairDescription(type, occupation);
