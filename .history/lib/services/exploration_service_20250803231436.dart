...
class ExplorationService {
  ...
  Cave generateCaveWithDetailedRolls(int entryRoll, int chamberTypeRoll, int contentRoll, int specialRoll) {
    ...
    final chamberDetails = _generateCaveChamberDetailsWithRolls(chamberTypeRoll, contentRoll, specialRoll);
...
''';
  ...
  String _generateCaveChamberDetailsWithRolls(int chamberRoll, int contentRoll, int specialRoll) {
    final chamber = _getCaveChamberType(chamberRoll);
    final content = _getCaveChamberContent(contentRoll);
    final special = _getCaveChamberSpecial(specialRoll);
...
''';
  ...
  Civilization generateDetailedCivilization() {
    ...
    final details = _generateDetailedCivilizationDetails(
      type,
      population,
      government,
    );
...
''';
  ...
  String _getRuinDefenses(int roll) {
    switch (roll) {
      case 1:
        return 'Nenhuma defesa';
      case 2:
        return 'Armadilhas simples';
      case 3:
        return 'Armadilhas complexas';
      case 4:
        return 'Guardiões';
      case 5:
  ...
  String _getOssuarySize(int roll) {
    switch (roll) {
      case 1:
        return 'Pequeno (${DiceRoller.rollStatic(1, 4)} indivíduos)';
      case 2:
        return 'Médio (${DiceRoller.rollStatic(1, 6)} indivíduos)';
      case 3:
        return 'Grande (${DiceRoller.rollStatic(2, 6)} indivíduos)';
      case 4:
        return 'Muito Grande (${DiceRoller.rollStatic(3, 6)} indivíduos)';
      case 5:
        return 'Enorme (${DiceRoller.rollStatic(4, 6)} indivíduos)';
      case 6:
        return 'Colossal (${DiceRoller.rollStatic(5, 6)} indivíduos)';
      default:
        return 'Médio (${DiceRoller.rollStatic(1, 6)} indivíduos)';
    }
  }
...
''';
  ...
  String _getRiversRoadsIslandsDirection(int roll) {
    switch (roll) {
      case 1:
        return '1 para 3 (Mesma Direção)';
      case 2:
        return '5 para 1 (Mesma Direção)';
      case 3:
        return '4 para 2 (Mesma Direção)';
      case 4:
        return '2 para 6 (Curva Esquerda)';
      case 5:
        return '3 para 5 (Curva Direita)';
      case 6:
        return '6 para 4 (Especial)';
      default:
        return '1 para 3 (Mesma Direção)';
    }
  }
  ...
  String _getTempleSanctuaryOccupants(int roll) {
    switch (roll) {
      ...
      case 3:
        return 'Abandonado com Guardião';
      case 4:
        return 'Religiosos (1d6 x 10)';
      case 5:
        return 'Religiosos (2d6 x 10)';
      case 6:
        return 'Religiosos (3d6 x 10)';
      default:
        return 'Abandonado';
    }
  }
  ...
  String _getCivilizationPopulation(int roll) {
    switch (roll) {
      case 1:
        return '1d10 x 10 habitantes';
      case 2:
        return '2d10 x 10 habitantes';
      case 3:
        return '3d10 x 10 habitantes';
      case 4:
        return '4d10 x 10 habitantes';
      case 5:
        return '5d10 x 10 habitantes';
      case 6:
        return '6d10 x 10 habitantes';
      default:
        return '2d10 x 10 habitantes';
    }
  }
  ...
  String _getLairDetails(LairType type, LairOccupation occupation) {
    ...
    switch (type) {
      case LairType.dungeons:
        return 'Estrutura subterrânea complexa com múltiplas salas e corredores.';
      case LairType.caves:
        return 'Formação natural com cavernas interconectadas.';
      case LairType.burrows:
        return 'Túneis escavados por criaturas subterrâneas.';
      case LairType.nests:
        return 'Local de nidificação em altura ou abrigo.';
      case LairType.camps:
        return 'Acampamento temporário com estruturas básicas.';
      case LairType.tribes:
        return 'Assentamento tribal com estruturas permanentes.';
      default:
  ...
  String _getNaturalDangerDetails(NaturalDangerType type) {
    switch (type) {
      case NaturalDangerType.quicksand:
        return 'Área de areia movediça que pode engolir viajantes.';
      case NaturalDangerType.thornyBushes:
        return 'Vegetação espinhosa que dificulta a passagem.';
      case NaturalDangerType.thermalSprings:
        return 'Fontes de água quente com vapores tóxicos.';
      case NaturalDangerType.tarPit:
        return 'Poço de alcatrão natural que prende criaturas.';
      case NaturalDangerType.mudVolcano:
        return 'Vulcão de lama que erupciona periodicamente.';
      case NaturalDangerType.earthquake:
        return 'Atividade sísmica que causa desabamentos.';
      default:
  ...
  String _getTrapDamage(TrapType trap) {
    switch (trap) {
      case TrapType.poisonedDarts:
        return '1d6 dardos / 1d4 de dano cada';
      ...
      case TrapType.acidSpray:
        return '1d4 de dano ácido';
      case TrapType.retractableCeiling:
        return 'Morte em 1d8 turnos';
    }
  }
