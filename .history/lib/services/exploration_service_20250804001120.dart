...
''';
  ...
  String _getNaturalDangerEffects(NaturalDangerType type) {
    switch (type) {
      ...
      case NaturalDangerType.mudVolcano:
        return 'Erupções de lama, terreno instável. Lama ácida causa 1d4 de dano regressivo.';
      ...
      case NaturalDangerType.sandstorm:
        return '1d4 de dano por turno. Cegueira e sufocamento possíveis.';
  ...
  String _getNaturalDangerDetails(NaturalDangerType type) {
    switch (type) {
      ...
      case NaturalDangerType.flooded:
        return 'Áreas alagadas causadas por enchentes ou corpos de água. Permite apenas movimento de natação.';
      case NaturalDangerType.sandstorm:
      ...
      case NaturalDangerType.altitude:
        return 'Altitudes acima de 2.000 metros. Falta de oxigênio causa exaustão. Custa 2 pontos de jornada.';
      default:
