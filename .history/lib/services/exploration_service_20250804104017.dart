    ...
    switch (type) {
      case TempleSanctuaryType.ziggurat:
        return _calculateDiceFormulas(
          '1 andar, obra terminará em 1d6 anos, perfeito estado, terra ou lama',
        );
      case TempleSanctuaryType.pyramid:
        return _calculateDiceFormulas(
          '2 andares, construído há 1d10+5 anos, perfeito estado, madeira',
        );
      case TempleSanctuaryType.obelisk:
        return _calculateDiceFormulas(
          '1d4 andares, construído há 1d4+1 décadas, bem conservado, granito',
        );
      case TempleSanctuaryType.temple:
        return _calculateDiceFormulas(
          '1 andar + 1 subterrâneo, construído há 1d4 séculos, decadente mas de pé, mármore',
        );
      case TempleSanctuaryType.sanctuary:
        return _calculateDiceFormulas(
          '2 andares + 2 subterrâneos, construído há 1d6+4 séculos, pode ruir, metal desconhecido',
        );
      case TempleSanctuaryType.altar:
        return _calculateDiceFormulas(
          '1d4 andares + 1d4 subterrâneos, construído em eras ancestrais, em ruínas, ouro',
        );
    }
  }
  ...
  String _getOtherOccupantsByTerrain(int terrainRoll) {
    ...
    switch (terrainRoll) {
      case 1: // Planície ou Floresta
        return 'Planície/Floresta: Humanos';
      case 2: // Colina ou Montanha
        return 'Colina/Montanha: Anões';
      case 3: // Pântano
        return 'Pântano: Goblin';
      case 4: // Deserto
        return 'Deserto: Drakold';
      case 5: // Geleira
        return 'Geleira: Goblin';
      case 6: // Oceano
        return 'Oceano: Goblin';
      default:
        return 'Humanos';
    }
  }
