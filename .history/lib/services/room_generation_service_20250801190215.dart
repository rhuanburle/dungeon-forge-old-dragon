...
class RoomGenerationService {
  ...
  RoomGenerationDto generateRoom(
    ...
    final monster = _getMonster(col10Roll, dungeonData.occupantI, dungeonData.occupantII);
    ...
    final magicItem = _getMagicItem(treasure, specialTreasure, adjustedCol15Roll);
