...
class RoomGenerationService {
  ...
  RoomGenerationDto generateRoom(
    ...
    // Debug temporário
    if (foundItem == FoundItem.specialItems) {
      print('DEBUG: col5Roll=$col5Roll, col6Roll=$col6Roll, specialItem=$specialItem');
    }
  ...
  SpecialItem? _getSpecialItem(int col5Roll, int col6Roll) {
    // Verifica se a coluna 5 indica item especial (roll 7-8)
