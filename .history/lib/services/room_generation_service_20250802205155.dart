...
class RoomGenerationService {
  ...
  Treasure _getTreasureWithModifiers(
    ...
    // MAS apenas se o tesouro base for magicItem ou specialTreasure
    if (baseTreasure == Treasure.magicItem || baseTreasure == Treasure.specialTreasure) {
      ...
      final modifiedTreasure = roomTable.getColumn13(modifiedRoll);
      
      // Se o tesouro modificado não for magicItem ou specialTreasure, 
      // retorna o tesouro base sem modificação
      if (modifiedTreasure != Treasure.magicItem && modifiedTreasure != Treasure.specialTreasure) {
        return baseTreasure;
      }
      
      return modifiedTreasure;
    }

    // Se não for magicItem ou specialTreasure, retorna o tesouro base sem modificação
    return baseTreasure;
  }
