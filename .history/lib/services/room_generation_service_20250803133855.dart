...
class RoomGenerationService {
  ...
  Treasure _getTreasureWithModifiers(
    ...
    // Garante que o roll está dentro dos limites válidos (2-12)
    modifiedRoll = modifiedRoll.clamp(2, 12);

    // Retorna o tesouro com o roll modificado
