...
class RoomTableService {
  ...
  static String _resolveSpecialReference(String reference, int col8Roll, int col9Roll) {
  ...
  static RoomTableDto generateRoomData({
    ...
    if (roomType == RoomType.specialRoom) {
      typeDescription = 'Sala Especial (${_getFromTable(_specialRoomTable, col8Roll)})';
      ...
      typeDescription = 'Sala Comum (${_getFromTable(_commonRoomTable, col7Roll)})';
    } else if (roomType == RoomType.specialTrap) {
      typeDescription = 'Sala Armadilha Especial (${_getFromTable(_specialTrapTable, col12Roll)})';
    }
