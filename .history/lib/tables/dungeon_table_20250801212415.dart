...
class DungeonTable extends TableWithColumnMethods<dynamic> {
  ...
  @override
  DungeonBuilder getColumn2(int roll) => super.getColumn2(roll) as DungeonBuilder;
  
  @override
  DungeonStatus getColumn3(int roll) => super.getColumn3(roll) as DungeonStatus;
  
  @override
  DungeonObjective getColumn4(int roll) => super.getColumn4(roll) as DungeonObjective;
  
  @override
  DungeonTarget getColumn5(int roll) => super.getColumn5(roll) as DungeonTarget;
  
  @override
  DungeonTargetStatus getColumn6(int roll) => super.getColumn6(roll) as DungeonTargetStatus;
  
  @override
  DungeonLocation getColumn7(int roll) => super.getColumn7(roll) as DungeonLocation;
  ...
  @override
  DungeonOccupant getColumn10(int roll) => super.getColumn10(roll) as DungeonOccupant;
  
  @override
  DungeonOccupant getColumn11(int roll) => super.getColumn11(roll) as DungeonOccupant;
  
  @override
  DungeonOccupant getColumn12(int roll) => super.getColumn12(roll) as DungeonOccupant;
  ...
  @override
  RumorLocation getColumn15(int roll) => super.getColumn15(roll) as RumorLocation;
} 