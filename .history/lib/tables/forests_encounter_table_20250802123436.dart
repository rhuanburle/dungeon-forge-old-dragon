...
///
/// Esta tabela gera encontros para florestas e áreas arborizadas,
...
class ForestsEncounterTable extends MonsterTable<dynamic> {
  ...
  @override
  String get description => 'Tabela de encontros para florestas e áreas arborizadas';
  ...
  List<List<dynamic>> get columns => [
        ...
        [
          ...
          MonsterType.thoul,
          MonsterType.worg,
          MonsterType.blackSpiderGiantForest,
