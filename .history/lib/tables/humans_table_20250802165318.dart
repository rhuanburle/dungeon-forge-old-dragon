...
class HumansTable extends MonsterTable<dynamic> {
  ...
  dynamic getSpecial(int roll) {
    // A coluna especial usa índices 1-10
    if (roll < 1 || roll > 10) {
      throw ArgumentError('Roll deve estar entre 1 e 10 para coluna especial');
    }
    // Sobrescrever para coluna especial que usa 1-10
    final column = columns[3]; // Coluna 4 (índice 3)
