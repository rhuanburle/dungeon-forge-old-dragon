...
class OccupantTable extends TableWithColumnMethods<dynamic> {
  ...
  @override
  DungeonOccupant getColumn1(int roll) => super.getColumn1(roll) as DungeonOccupant;
  
  @override
  DungeonOccupant getColumn2(int roll) => super.getColumn2(roll) as DungeonOccupant;
  
  @override
  DungeonOccupant getColumn3(int roll) => super.getColumn3(roll) as DungeonOccupant;
} 