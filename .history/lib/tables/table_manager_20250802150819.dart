...
import 'hills_encounter_table.dart';
import 'mountains_encounter_table.dart';
...
class TableManager {
  ...
  final HillsEncounterTable _hillsEncounterTable = HillsEncounterTable();
  final MountainsEncounterTable _mountainsEncounterTable = MountainsEncounterTable();
  final SwampsEncounterTable _swampsEncounterTable = SwampsEncounterTable();
  final GlaciersEncounterTable _glaciersEncounterTable = GlaciersEncounterTable();
  ...
  /// Obtém a tabela de encontros em colinas (Tabela A13.3)
  HillsEncounterTable get hillsEncounterTable => _hillsEncounterTable;

  /// Obtém a tabela de encontros em montanhas (Tabela A13.4)
  MountainsEncounterTable get mountainsEncounterTable => _mountainsEncounterTable;

  /// Obtém a tabela de encontros em pântanos (Tabela A13.5)
  SwampsEncounterTable get swampsEncounterTable => _swampsEncounterTable;

  /// Obtém a tabela de encontros em geleiras (Tabela A13.6)
  GlaciersEncounterTable get glaciersEncounterTable => _glaciersEncounterTable;
  ...
  List<BaseTable> get allTables => [
    ...
    _hillsEncounterTable,
    _mountainsEncounterTable,
