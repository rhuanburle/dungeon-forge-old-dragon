...
class AppColors {
  ...
  static const Color primary =
      Color(0xFFDC2626); // Red 600 - Vermelho Old Dragon
  static const Color primaryLight =
      Color(0xFFEF4444); // Red 500 - Vermelho mais claro
  static const Color primaryDark =
      Color(0xFFB91C1C); // Red 700 - Vermelho mais escuro
  ...
  static const Color borderAccent =
      Color(0xFFDC2626); // Vermelho para bordas especiais
  ...
  static const Color active =
      Color(0xFFDC2626); // Vermelho para elementos ativos
}
