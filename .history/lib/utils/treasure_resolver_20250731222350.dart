...
class TreasureResolver {
  static String resolve(String template) {
    ...
    for (var rawPart in parts) {
      ...
      if (part.contains('Qualquer') || part.contains('Poção') || 
          part.contains('Pergaminho') || part.contains('Arma')) {
      ...
      if (match != null) {
        ...
        if (unit == 'Gemas') {
          ...
          results.add('$value Objetos de Valor: ${_resolveObjetosDeValor(value)}');
        } else {
  ...
  static String _resolveObjetosDeValor(int count) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      switch (tipo) {
        case 'Obras de Arte':
          switch (itemRoll) {
            case 2: case 3: item = 'Móveis com Marchetaria'; break;
            case 4: case 5: item = 'Tapeçaria Fina'; break;
            case 6: case 7: item = 'Livro Raro'; break;
            case 8: case 9: item = 'Escultura'; break;
            case 10: case 11: item = 'Tela Pintada'; break;
            default: item = 'Estatueta em Bronze';
          }
          break;
        case 'Utensílios':
          switch (itemRoll) {
            case 2: case 3: item = 'Religiosos de Cobre'; break;
            case 4: case 5: item = 'Talheres de Prata'; break;
            case 6: case 7: item = 'Candelabros de Prata'; break;
            case 8: case 9: item = 'Cutelaria Fina'; break;
            case 10: case 11: item = 'Cálices de Ouro'; break;
            default: item = 'Religiosos de Ouro';
          }
          break;
        case 'Mercadoria':
          switch (itemRoll) {
            case 2: case 3: item = 'Peles de Animais Raros'; break;
            case 4: case 5: item = 'Objetos de Marfim'; break;
            case 6: case 7: item = 'Sacas de Especiaria'; break;
            case 8: case 9: item = 'Sacas de Incenso'; break;
            case 10: case 11: item = 'Tecidos Nobres'; break;
            default: item = 'Metros de Fina Seda';
          }
          break;
        case 'Louças':
          switch (itemRoll) {
            case 2: case 3: item = 'Objetos de Vidro Soprado'; break;
            case 4: case 5: item = 'Copos de Vidro e com Prata'; break;
            case 6: case 7: item = 'Baixelas de Louça'; break;
            case 8: case 9: item = 'Baixelas de Porcelana com ouro'; break;
            case 10: case 11: item = 'Vaso de Porcelana'; break;
            default: item = 'Cálices de Vidro com pedraria';
          }
          break;
        case 'Joias':
          switch (itemRoll) {
            case 2: case 3: item = 'Cordão de Prata'; break;
            case 4: case 5: item = 'Brincos de Pérola'; break;
            case 6: case 7: item = 'Bracelete de Prata'; break;
            case 8: case 9: item = 'Pingente de Pedraria'; break;
            case 10: case 11: item = 'Camafeu de Ouro'; break;
            default: item = 'Tiara com Pedraria';
          }
          break;
        default:
          item = 'Item de Valor';
