  ...
  group('Dungeon Generator Integration Tests', () {
    ...
    group('complete generation flow', () {
      ...
      test('should generate different dungeons on multiple calls', () {
        ...
        for (int i = 0; i < 5; i++) {
          dungeons
              .add(generator.generate(level: 3, theme: 'Diversity Test $i'));
        }
    ...
    group('room generation validation', () {
      ...
      test('should generate rooms with different types', () {
        ...
        expect(roomTypes.length, greaterThan(1),
      ...
      test('should generate proper monster encounters', () {
        ...
        final monsterRooms =
            dungeon.rooms.where((r) => r.type.contains('Encontro')).toList();
    ...
    group('edge cases and stress tests', () {
      ...
      test('should handle empty theme', () {
        ...
        expect(dungeon.theme, isEmpty);
        expect(dungeon.rooms.length, equals(3));
      });

      group('Treasure Level Auto-Configuration Integration', () {
        test('should auto-configure treasure level based on party level in complete flow', () {
          final dungeon = generator.generate(
            level: 3,
            theme: 'Test Dungeon',
            customRoomCount: 5,
          ...
          expect(dungeon.theme, equals('Test Dungeon'));
        ...
        test('should work with encounter tables and treasure auto-configuration', () {
          final dungeon = generator.generate(
            level: 3,
          ...
          // Verifica se a masmorra foi gerada corretamente
          expect(dungeon.theme, equals('Encounter Test'));
          expect(dungeon.rooms.length, equals(3));
        ...
        test('should maintain manual treasure level override in complete flow', () {
          final dungeon = generator.generate(
            level: 3,
            ...
            treasureLevel: TreasureLevel.level10plus, // Mas foi sobrescrito manualmente
            useTreasureByLevel: true,
          );

          // Verifica se a masmorra foi gerada corretamente
          expect(dungeon.theme, equals('Manual Override Test'));
        ...
        test('should not auto-configure when treasure by level is disabled', () {
          final dungeon = generator.generate(
            level: 3,
          ...
          // Verifica se a masmorra foi gerada corretamente
          expect(dungeon.theme, equals('Standard Treasure Test'));
          expect(dungeon.rooms.length, equals(3));
...
void _validateDungeonProperties(Dungeon dungeon) {
  ...
  expect(dungeon.roomsCount, greaterThan(0),
