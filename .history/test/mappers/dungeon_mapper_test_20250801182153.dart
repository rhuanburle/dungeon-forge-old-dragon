  ...
  group('DungeonMapper', () {
    ...
    group('fromRoomDto', () {
      test('should convert RoomGenerationDto to Room correctly', () {
        ...
        expect(room.treasure, anyOf(equals('Item Mágico'), isNotEmpty)); // May be resolved
        expect(room.specialTreasure, equals(''));
        expect(room.magicItem, isNotEmpty); // Should be resolved from '1 Qualquer'
      });
      ...
      test('should handle monster with multiple creatures correctly', () {
        ...
        final room = DungeonMapper.fromRoomDto(dto, 1, testDungeonDto);
        expect(room.monster1, equals('Novo Monstro'));
        expect(room.monster2, equals('Trolls')); // Should be resolved from 'Ocupante I'
      });
      ...
      test('should handle special treasure correctly', () {
        ...
        final room = DungeonMapper.fromRoomDto(dto, 1, testDungeonDto);
        expect(room.treasure, isNotEmpty); // Should be resolved by TreasureResolver
