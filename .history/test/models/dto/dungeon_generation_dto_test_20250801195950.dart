...
void main() {
  ...
  group('RoomGenerationDto', () {
    ...
    test('hasTrap should return true for trap and specialTrap types', () {
      final trapDto = dto.copyWith(type: RoomType.trap, trap: Trap.hiddenGuillotine);
      final specialTrapDto = dto.copyWith(type: RoomType.specialTrap, specialTrap: SpecialTrap.waterWell);
    ...
    test('hasMonster should return true for monster type', () {
      final monsterDto = dto.copyWith(type: RoomType.monster, monster: Monster.newMonster);
