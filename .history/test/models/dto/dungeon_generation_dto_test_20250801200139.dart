...
void main() {
  ...
  group('RoomGenerationDto', () {
    ...
    test('hasTrap should return true for trap and specialTrap types', () {
      final trapDto = dto.copyWith(type: RoomType.trap, trap: Trap.hiddenGuillotine, monster: null);
      final specialTrapDto = dto.copyWith(type: RoomType.specialTrap, specialTrap: SpecialTrap.waterWell, monster: null);
      final monsterDto = dto.copyWith(type: RoomType.monster, trap: null, specialTrap: null);
    ...
    test('hasMonster should return true for monster type', () {
      final monsterDto = dto.copyWith(type: RoomType.monster, monster: Monster.newMonster, trap: null, specialTrap: null);
