...
void main() {
  group('DungeonGenerationDto', () {
    ...
    test('should create instance with all required properties', () {
      ...
      expect(
          dto.builderOrInhabitant, equals(DungeonBuilder.unknown.description));
      ...
      expect(dto.targetStatus,
          equals(DungeonTargetStatus.beingSought.description));
      ...
      expect(dto.rumorLocation,
          equals(RumorLocation.autumnReligiousFestival.description));
    });
    ...
    test('resolveRumorReferences should replace column references', () {
      final dtoWithReferences = DungeonGenerationDto(
        type: DungeonType.lostConstruction.description,
        builderOrInhabitant: DungeonBuilder.unknown.description,
        status: DungeonStatus.cursed.description,
        objective: DungeonObjective.defend.description,
  ...
  group('RoomGenerationDto', () {
    ...
    test('hasTrap should return true for trap and specialTrap types', () {
      final trapDto = dto.copyWith(
          type: RoomType.trap.description,
          trap: Trap.hiddenGuillotine.description,
          monster: null);
      ...
      final monsterDto = dto.copyWith(
          type: RoomType.monster.description, trap: null, specialTrap: null);
    ...
    test('hasMonster should return true for monster type', () {
      final monsterDto = dto.copyWith(
          ...
          specialTrap: null);
      final trapDto =
          dto.copyWith(type: RoomType.trap.description, monster: null);
    ...
    test('should have correct treasure status', () {
      final treasureDto =
          dto.copyWith(treasure: Treasure.magicItem.description);
      final noTreasureDto =
          dto.copyWith(treasure: Treasure.noTreasure.description);
