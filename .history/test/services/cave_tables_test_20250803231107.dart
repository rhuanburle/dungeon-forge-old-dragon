  ...
  group('Cave Tables Tests', () {
    ...
    group('Table 4.17 - Detalhando Cavernas', () {
      ...
      test('should have correct chamber contents', () {
        ...
        // Verificar se contém pelo menos um dos conteúdos válidos
        final hasValidContent = chamberDetails.contains('Câmara vazia') ||
            chamberDetails.contains('Encontro no subterrâneo') ||
            chamberDetails.contains('Sem saída') ||
            chamberDetails.contains('Fosso para baixo') ||
            chamberDetails.contains('Túnel para cima') ||
            chamberDetails.contains('Relíquias') ||
            chamberDetails.contains('Riacho subterrâneo') ||
            chamberDetails.contains('Lago subterrâneo') ||
            chamberDetails.contains('Encruzilhada');
