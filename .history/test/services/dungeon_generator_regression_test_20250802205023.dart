...
void main() {
  ...
  group('Magic Item frequency validation', () {
    test('should have correct magic item frequency according to table 9.2', () {
      ...
      // Conforme análise da IA:
      // - Sala comum (sem bônus): ~10-15%
      // - Sala de armadilha (+1): ~20-25%
      // - Sala de monstro (+2): ~30-35%
      
      // Frequência esperada: aproximadamente 15-25% das salas
      expect(magicItemFrequency, greaterThan(0.10)); // Mínimo 10%
      expect(magicItemFrequency, lessThan(0.30)); // Máximo 30%
