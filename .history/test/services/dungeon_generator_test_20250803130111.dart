...
void main() {
  group('DungeonGenerator Tests', () {
    ...
    test('should regenerate occupants and update room monsters', () {
      // Arrange
      ...
      print('DEBUG: Ocupantes iniciais - monster1: $initialMonster1, monster2: $initialMonster2');
      ...
      print('DEBUG: Ocupantes após regeneração - monster1: $newMonster1, monster2: $newMonster2');
      
      expect(newMonster1, isNotEmpty);
      expect(newMonster2, isNotEmpty);
