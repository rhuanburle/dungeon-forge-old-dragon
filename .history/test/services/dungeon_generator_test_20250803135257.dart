...
void main() {
  group('DungeonGenerator Tests', () {
    ...
    group('Monster Level to Treasure Level Auto-Configuration', () {
      test('should auto-configure treasure level 1 for beginner monster level', () {
        final dungeon = generator.generate(
          level: 3,
          theme: 'Test Theme',
          customRoomCount: 5,
      ...
      test('should auto-configure treasure level 2-3 for heroic monster level', () {
        final dungeon = generator.generate(
          level: 3,
          theme: 'Test Theme',
          customRoomCount: 5,
      ...
      test('should auto-configure treasure level 6-7 for advanced monster level', () {
        final dungeon = generator.generate(
          level: 3,
          theme: 'Test Theme',
          customRoomCount: 5,
      ...
      test('should allow manual override of auto-configured treasure level', () {
        final dungeon = generator.generate(
          level: 3,
          theme: 'Test Theme',
          customRoomCount: 5,
          difficultyLevel: DifficultyLevel.beginner, // Deveria configurar nível 1
          treasureLevel: TreasureLevel.level8to9, // Mas foi sobrescrito manualmente
          useTreasureByLevel: true,
        );
      ...
      test('should not auto-configure when useTreasureByLevel is false', () {
        final dungeon = generator.generate(
          ...
          theme: 'Test Theme',
          customRoomCount: 5,
          difficultyLevel: DifficultyLevel.advanced, // Deveria configurar nível 6-7
      ...
      test('should auto-configure treasure level when treasureLevel is null', () {
        final dungeon = generator.generate(
          level: 3,
          theme: 'Test Theme',
          customRoomCount: 5,
