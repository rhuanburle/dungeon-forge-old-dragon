  ...
  group('DungeonGenerator Tests', () {
    ...
    test(
      ...
      () {
        ...
        expect(hasLevelTreasure, isTrue, reason: 'Should have treasure by level format');
        expect(hasStandardTreasure, isTrue, reason: 'Should have standard treasure format');
      },
    );
