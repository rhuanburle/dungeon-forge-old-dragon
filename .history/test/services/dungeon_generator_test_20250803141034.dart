...
void main() {
  group('DungeonGenerator Tests', () {
    ...
    group('Treasure System Parallel Tests', () {
      ...
      test('should use table 9.2 treasure when treasure by level is disabled', () {
        final dungeon = generator.generate(
          level: 3,
          theme: 'Test Theme',
          customRoomCount: 5,
        ...
        for (final room in dungeon.rooms) {
          if (room.treasure.isNotEmpty || room.specialTreasure.isNotEmpty || room.magicItem.isNotEmpty) {
      ...
      test('should preserve special items when using treasure by level', () {
        final dungeon = generator.generate(
          level: 3,
          theme: 'Test Theme',
          customRoomCount: 10, // Mais salas para aumentar chance de itens especiais
          useTreasureByLevel: true,
          treasureLevel: TreasureLevel.level1,
        );

        // Verifica se itens especiais são preservados
