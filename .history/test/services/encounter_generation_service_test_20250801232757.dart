...
import 'encounter_generation_service_test.mocks.dart';

@GenerateMocks([DiceRoller])
void main() {
  group('EncounterGenerationService', () {
    late EncounterGenerationService service;
    late MockDiceRoller mockDiceRoller;

    setUp(() {
      mockDiceRoller = MockDiceRoller();
      service = EncounterGenerationService(diceRoller: mockDiceRoller);
    });
    ...
    test('should generate encounter for subterranean terrain', () {
      ...
      when(mockDiceRoller.rollDice(6)).thenReturn(3); // 3d6 for quantity
      ...
      expect(encounter.monsterType, MonsterType.giantRat);
      expect(encounter.quantity, 3);
