...
void main() {
  group('EncounterGenerationService Terrain Test', () {
    ...
    test('should simulate UI flow for different terrains', () {
      ...
      final difficulties = [DifficultyLevel.easy, DifficultyLevel.medium, DifficultyLevel.challenging];
      final partyLevels = [PartyLevel.beginners, PartyLevel.heroic, PartyLevel.advanced];
