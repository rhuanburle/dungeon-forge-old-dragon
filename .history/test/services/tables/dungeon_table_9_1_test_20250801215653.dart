  ...
  group('DungeonTable', () {
    ...
    group('table info', () {
      test('should return correct table information', () {
        expect(dungeonTable.tableName, equals('Tabela 9.1 - Geração de Masmorras'));
        expect(dungeonTable.description, equals('Tabela para gerar dados básicos de masmorras'));
    ...
    group('specific column tests', () {
      test('column 1 - DungeonType should return correct values', () {
        expect(dungeonTable.getColumn1(2), equals(DungeonType.lostConstruction));
        expect(dungeonTable.getColumn1(3), equals(DungeonType.lostConstruction));
        expect(dungeonTable.getColumn1(4), equals(DungeonType.artificialLabyrinth));
        expect(dungeonTable.getColumn1(5), equals(DungeonType.artificialLabyrinth));
        ...
        expect(dungeonTable.getColumn1(10), equals(DungeonType.abandonedFortress));
        expect(dungeonTable.getColumn1(11), equals(DungeonType.abandonedFortress));
        expect(dungeonTable.getColumn1(12), equals(DungeonType.deactivatedMine));
      });
      ...
      test('column 2 - DungeonBuilder should return correct values', () {
        ...
        expect(dungeonTable.getColumn2(6), equals(DungeonBuilder.ancestralCivilization));
        expect(dungeonTable.getColumn2(7), equals(DungeonBuilder.ancestralCivilization));
      ...
      test('column 3 - DungeonStatus should return correct values', () {
        ...
        expect(dungeonTable.getColumn3(12), equals(DungeonStatus.inAnotherLocation));
      });
      ...
      test('column 10 - DungeonOccupant (Ocupante I) should return correct values', () {
      ...
      test('column 11 - DungeonOccupant (Ocupante II) should return correct values', () {
        ...
        expect(dungeonTable.getColumn11(10), equals(DungeonOccupant.pygmyFungi));
        expect(dungeonTable.getColumn11(11), equals(DungeonOccupant.pygmyFungi));
      ...
      test('column 12 - DungeonOccupant (Líder) should return correct values', () {
        ...
        expect(dungeonTable.getColumn12(4), equals(DungeonOccupant.gelatinousCube));
        expect(dungeonTable.getColumn12(5), equals(DungeonOccupant.gelatinousCube));
        ...
        expect(dungeonTable.getColumn12(10), equals(DungeonOccupant.necromancer));
        expect(dungeonTable.getColumn12(11), equals(DungeonOccupant.necromancer));
    ...
    group('generic methods', () {
      test('getColumnValue should work correctly', () {
        expect(dungeonTable.getColumnValue(1, 6), equals(DungeonType.naturalCaves));
        expect(dungeonTable.getColumnValue(2, 6), equals(DungeonBuilder.ancestralCivilization));
        expect(dungeonTable.getColumnValue(3, 6), equals(DungeonStatus.ancestral));
      });
      ...
      test('getColumnValues should return all values for a column', () {
        ...
        expect(column1Values[0], equals(DungeonType.lostConstruction)); // roll 2
        expect(column1Values[11], equals(DungeonType.deactivatedMine)); // roll 12
      });
    });
  });
}
