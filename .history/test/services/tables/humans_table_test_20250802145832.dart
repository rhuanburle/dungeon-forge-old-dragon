...
void main() {
  group('HumansTable', () {
    ...
    test('should have correct table properties', () {
      ...
      expect(table.description, equals('Tabela de humanos e semi-humanos por nível'));
    ...
    test('should return correct values for beginners column', () {
      ...
      expect(table.getBeginners(11), equals(MonsterType.caveMen));
    });
    ...
    test('should work with getByPartyLevel method', () {
      expect(table.getByPartyLevel(PartyLevel.beginners, 1), equals(MonsterType.caveMen));
      expect(table.getByPartyLevel(PartyLevel.heroic, 1), equals(MonsterType.caveMen));
      expect(table.getByPartyLevel(PartyLevel.advanced, 1), equals(MonsterType.caveMen));
    });
