  ...
  group('OccupantTable', () {
    ...
    group('table info', () {
      test('should return correct table information', () {
        expect(occupantTable.tableName,
            equals('Tabela de Ocupantes (Colunas 10-12 da Tabela 9.1)'));
        expect(occupantTable.description,
            equals('Tabela para gerar ocupantes da masmorra'));
    ...
    group('specific column tests', () {
      test(
          'column 1 - DungeonOccupant (Ocupante I) should return correct values',
          () {
      ...
      test(
          'column 2 - DungeonOccupant (Ocupante II) should return correct values',
          () {
        ...
        expect(
            occupantTable.getColumn2(10), equals(DungeonOccupant.pygmyFungi));
        expect(
            occupantTable.getColumn2(11), equals(DungeonOccupant.pygmyFungi));
      ...
      test('column 3 - DungeonOccupant (Líder) should return correct values',
        ...
        expect(occupantTable.getColumn3(4),
            equals(DungeonOccupant.gelatinousCube));
        expect(occupantTable.getColumn3(5),
            equals(DungeonOccupant.gelatinousCube));
        ...
        expect(
            occupantTable.getColumn3(10), equals(DungeonOccupant.necromancer));
        expect(
            occupantTable.getColumn3(11), equals(DungeonOccupant.necromancer));
    ...
    group('generic methods', () {
      test('getColumnValue should work correctly', () {
        expect(occupantTable.getColumnValue(1, 6),
            equals(DungeonOccupant.skeletons));
        expect(occupantTable.getColumnValue(2, 6),
            equals(DungeonOccupant.zombies));
        expect(occupantTable.getColumnValue(3, 6),
            equals(DungeonOccupant.cultist));
      });
