  ...
  group('RoomTable9_2', () {
    ...
    group('specific column tests', () {
      ...
      test('column 10 - Monster should return correct values', () {
        expect(RoomTable9_2.getColumn10(2), equals(Monster.newMonsterPlusOccupantI));
        expect(RoomTable9_2.getColumn10(3), equals(Monster.newMonsterPlusOccupantI));
        expect(RoomTable9_2.getColumn10(4), equals(Monster.occupantIPlusOccupantII));
        expect(RoomTable9_2.getColumn10(5), equals(Monster.occupantIPlusOccupantII));
        ...
        expect(RoomTable9_2.getColumn10(12), equals(Monster.newMonsterPlusOccupantII));
      });
      ...
      test('column 12 - SpecialTrap should return correct values', () {
        ...
        expect(RoomTable9_2.getColumn12(6), equals(SpecialTrap.retractableCeiling));
        expect(RoomTable9_2.getColumn12(7), equals(SpecialTrap.retractableCeiling));
        ...
        expect(RoomTable9_2.getColumn12(12), equals(SpecialTrap.dimensionalPortal));
      });
