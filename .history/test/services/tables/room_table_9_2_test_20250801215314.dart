  ...
  group('RoomTable', () {
    ...
    group('table info', () {
      test('should return correct table information', () {
        expect(roomTable.tableName, equals('Tabela 9.2 - Salas e Câmaras de Masmorras'));
        expect(roomTable.description, equals('Tabela para gerar dados de salas individuais'));
    ...
    group('specific column tests', () {
      ...
      test('column 6 - SpecialItem should return correct values', () {
        ...
        expect(roomTable.getColumn6(10), equals(SpecialItem.emptyBoxesBagsChests));
        expect(roomTable.getColumn6(11), equals(SpecialItem.emptyBoxesBagsChests));
        expect(roomTable.getColumn6(12), equals(SpecialItem.fullBoxesBagsChests));
      });
      ...
      test('column 10 - Monster should return correct values', () {
        expect(roomTable.getColumn10(2), equals(Monster.newMonsterPlusOccupantI));
        expect(roomTable.getColumn10(3), equals(Monster.newMonsterPlusOccupantI));
        expect(roomTable.getColumn10(4), equals(Monster.occupantIPlusOccupantII));
        expect(roomTable.getColumn10(5), equals(Monster.occupantIPlusOccupantII));
        ...
        expect(roomTable.getColumn10(12), equals(Monster.newMonsterPlusOccupantII));
      });
      ...
      test('column 12 - SpecialTrap should return correct values', () {
        ...
        expect(roomTable.getColumn12(6), equals(SpecialTrap.retractableCeiling));
        expect(roomTable.getColumn12(7), equals(SpecialTrap.retractableCeiling));
        ...
        expect(roomTable.getColumn12(12), equals(SpecialTrap.dimensionalPortal));
      });
      ...
      test('column 14 - SpecialTreasure should return correct values', () {
        expect(roomTable.getColumn14(2), equals(SpecialTreasure.rollAgainPlusMagicItem));
        expect(roomTable.getColumn14(3), equals(SpecialTreasure.rollAgainPlusMagicItem));
        expect(roomTable.getColumn14(4), equals(SpecialTreasure.copperSilverGems));
        expect(roomTable.getColumn14(5), equals(SpecialTreasure.copperSilverGems));
        expect(roomTable.getColumn14(6), equals(SpecialTreasure.copperSilverGems2));
        expect(roomTable.getColumn14(7), equals(SpecialTreasure.copperSilverGems2));
        expect(roomTable.getColumn14(8), equals(SpecialTreasure.copperSilverGemsValuable));
        expect(roomTable.getColumn14(9), equals(SpecialTreasure.copperSilverGemsValuable));
        expect(roomTable.getColumn14(10), equals(SpecialTreasure.copperSilverGemsMagicItem));
        expect(roomTable.getColumn14(11), equals(SpecialTreasure.copperSilverGemsMagicItem));
        expect(roomTable.getColumn14(12), equals(SpecialTreasure.rollAgainPlusMagicItem2));
      });
    ...
    group('generic methods', () {
      ...
      test('getColumnValues should return all values for a column', () {
        ...
        expect(column1Values[10], equals(RoomType.specialTrap)); // roll 12
      });
    });
  });
}
