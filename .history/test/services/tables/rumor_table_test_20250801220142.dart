  ...
  group('RumorTable', () {
    ...
    group('table info', () {
      test('should return correct table information', () {
        expect(rumorTable.tableName,
            equals('Tabela de Rumores (Colunas 13-15 da Tabela 9.1)'));
        expect(rumorTable.description,
            equals('Tabela para gerar rumores sobre a masmorra'));
    ...
    group('specific column tests', () {
      test('column 1 - RumorSubject should return correct values', () {
        expect(
            rumorTable.getColumn1(2), equals(RumorSubject.decapitatedOccupant));
        expect(
            rumorTable.getColumn1(3), equals(RumorSubject.decapitatedOccupant));
      ...
      test('column 2 - RumorAction should return correct values', () {
        ...
        expect(
            rumorTable.getColumn2(10), equals(RumorAction.killedByWerewolfIn));
        expect(
            rumorTable.getColumn2(11), equals(RumorAction.killedByWerewolfIn));
        expect(rumorTable.getColumn2(12), equals(RumorAction.cursed));
      });

      test('column 3 - RumorLocation should return correct values', () {
        expect(rumorTable.getColumn3(2),
            equals(RumorLocation.autumnReligiousFestival));
        expect(rumorTable.getColumn3(3),
            equals(RumorLocation.autumnReligiousFestival));
        expect(rumorTable.getColumn3(4),
            equals(RumorLocation.villageLastYearDuringEclipse));
        expect(rumorTable.getColumn3(5),
            equals(RumorLocation.villageLastYearDuringEclipse));
        expect(rumorTable.getColumn3(6),
            equals(RumorLocation.farmWhenSheepDisappeared));
        expect(rumorTable.getColumn3(7),
            equals(RumorLocation.farmWhenSheepDisappeared));
        ...
        expect(rumorTable.getColumn3(10),
            equals(RumorLocation.springTradeCaravan));
        expect(rumorTable.getColumn3(11),
            equals(RumorLocation.springTradeCaravan));
        expect(rumorTable.getColumn3(12),
            equals(RumorLocation.winterBlizzard3YearsAgo));
      });
    });

    group('generic methods', () {
      test('getColumnValue should work correctly', () {
        expect(rumorTable.getColumnValue(1, 6),
            equals(RumorSubject.primaryOccupant));
        expect(
            rumorTable.getColumnValue(2, 6), equals(RumorAction.leftTrailsIn));
        expect(rumorTable.getColumnValue(3, 6),
            equals(RumorLocation.farmWhenSheepDisappeared));
      });
      ...
      test('getColumnValues should return all values for a column', () {
        ...
        expect(column1Values[0],
            equals(RumorSubject.decapitatedOccupant)); // roll 2
        expect(column1Values[11], equals(RumorSubject.leader)); // roll 12
      });
    });
  });
}
