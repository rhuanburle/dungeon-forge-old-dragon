...
import 'package:dungeon_forge/tables/table_manager.dart';
...
void main() {
  group('TableManager', () {
    ...
    test('should return table names', () {
      ...
      expect(names, contains('Tabela 9.1 - Masmorras'));
      expect(names, contains('Tabela 9.2 - Salas'));
    ...
    test('should find table by name', () {
      final manager = TableManager();
      final table = manager.getTableByName('Tabela 9.1 - Masmorras');
      expect(table, isNotNull);
      expect(table!.tableName, equals('Tabela 9.1 - Masmorras'));
    });
    ...
    test('should check if table exists', () {
      final manager = TableManager();
      expect(manager.hasTable('Tabela 9.1 - Masmorras'), isTrue);
    ...
    test('should get all tables info', () {
      ...
      expect(info, contains('Tabela 9.1 - Masmorras'));
      expect(info, contains('Tabela 9.2 - Salas'));
