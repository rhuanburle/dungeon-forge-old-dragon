...
void main() {
  group('TableManager', () {
    ...
    test('should work with monster encounter tables', () {
      ...
      expect(manager.animalsTable.tableName,
          equals('Tabela A13.2 - Animais'));
      expect(manager.humansTable.tableName,
          equals('Tabela A13.11 - Humanos e Semi-Humanos'));
      expect(manager.extraplanarTable.tableName,
          equals('Tabela A13.10 - Encontros Extraplanares'));
      expect(manager.anyHabitatTable.tableName,
