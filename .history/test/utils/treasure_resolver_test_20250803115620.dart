...
void main() {
  ...
  group('TreasureResolver By Level Tests', () {
    ...
    test('should apply treasure by level to dungeon rooms', () {
      ...
      // Verifica se o tesouro contém os componentes esperados para o nível 4-5
      ...
      // Verifica se não contém "Nenhum" para itens mágicos no nível 4-5
      expect(treasure, isNot(contains('Nenhum Item Mágico')));
    });
  });
}
