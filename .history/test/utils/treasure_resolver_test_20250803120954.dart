...
void main() {
  ...
  group('TreasureResolver By Level Tests', () {
    ...
    test('should extract treasure components correctly', () {
      ...
      String specialItemComponent = '';
      String magicItemComponent = '';
      
      for (final line in lines) {
        if (line.contains('PO:') || line.contains('PP:')) {
          treasureComponent += (treasureComponent.isNotEmpty ? ' + ' : '') + line;
        } else if (line.contains('Gemas:') || line.contains('Objetos de Valor:')) {
          if (!line.contains('Nenhuma Gema') && !line.contains('Nenhum Objeto de Valor')) {
            specialItemComponent += (specialItemComponent.isNotEmpty ? ' + ' : '') + line;
          }
        } else if (line.contains('Itens Mágicos:')) {
          if (!line.contains('Nenhum Item Mágico')) {
            magicItemComponent += (magicItemComponent.isNotEmpty ? ' + ' : '') + line;
          }
        }
      }
      ...
      // Verifica se specialItem e magicItem podem estar vazios ou preenchidos
