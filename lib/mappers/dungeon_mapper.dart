...
class DungeonMapper {
  ...
  static String _buildMonster1(
    ...
    result = result.replaceAll('Ocupante I', dungeonDto.occupantI.description);
    result =
        result.replaceAll('Ocupante II', dungeonDto.occupantII.description);
  ...
  static String _buildMonster2(
    ...
    if (result.isNotEmpty) {
      // Resolve referências de ocupantes
      result =
          result.replaceAll('Ocupante I', dungeonDto.occupantI.description);
      result =
          result.replaceAll('Ocupante II', dungeonDto.occupantII.description);
    }
