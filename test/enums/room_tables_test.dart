  ...
  group('RoomTables Enums', () {
    group('RoomType', () {
      ...
      test('should have correct descriptions', () {
        ...
        expect(RoomType.specialTrap.description,
            equals('Sala Armadilha Especial'));
      });
    });
    ...
    group('AirCurrent', () {
      ...
      test('should have correct descriptions', () {
        expect(
            AirCurrent.hotDraft.description, equals('corrente de ar quente'));
        expect(
            AirCurrent.lightHotBreeze.description, equals('leve brisa quente'));
        expect(
            AirCurrent.noAirCurrent.description, equals('sem corrente de ar'));
        expect(
            AirCurrent.lightColdBreeze.description, equals('leve brisa fria'));
        expect(AirCurrent.coldDraft.description, equals('corrente de ar fria'));
        expect(AirCurrent.strongIcyWind.description,
            equals('vento forte e gelado'));
      });
    });
    ...
    group('Smell', () {
      ...
      test('should have correct descriptions', () {
        ...
        expect(
            Smell.humidityMold.description, equals('cheiro de umidade e mofo'));
    ...
    group('FoundItem', () {
      ...
      test('should have correct descriptions', () {
        expect(FoundItem.completelyEmpty.description,
            equals('completamente vazia'));
        expect(FoundItem.dustDirtWebs.description,
            equals('poeira, sujeira e teias'));
        expect(FoundItem.oldFurniture.description, equals('móveis velhos'));
        expect(FoundItem.specialItems.description,
            equals('itens encontrados especial…'));
        expect(FoundItem.foodRemainsGarbage.description,
            equals('restos de comida e lixo'));
        expect(FoundItem.dirtyFetidClothes.description,
            equals('roupas sujas e fétidas'));
      });
    });
    ...
    group('SpecialItem', () {
      ...
      test('should have correct descriptions', () {
        expect(SpecialItem.monsterCarcasses.description,
            equals('carcaças de monstros'));
        expect(SpecialItem.oldTornPapers.description,
            equals('papéis velhos e rasgados'));
        expect(
            SpecialItem.piledBones.description, equals('ossadas empilhadas'));
        expect(SpecialItem.dirtyFabricRemains.description,
            equals('restos de tecidos sujos'));
        expect(SpecialItem.emptyBoxesBagsChests.description,
            equals('caixas, sacos e baús vazios'));
        expect(SpecialItem.fullBoxesBagsChests.description,
    ...
    group('CommonRoom', () {
      ...
      test('should have correct descriptions', () {
        ...
        expect(CommonRoom.completelyEmpty.description,
            equals('completamente vazia'));
    ...
    group('SpecialRoom', () {
      ...
      test('should have correct descriptions', () {
        expect(SpecialRoom.trainingRoom.description,
            equals('sala de treinamento'));
        expect(SpecialRoom.diningRoom.description, equals('refeitório'));
        expect(SpecialRoom.completelyEmpty.description,
            equals('completamente vazia'));
        expect(SpecialRoom.special2.description, equals('Especial 2…'));
        expect(
            SpecialRoom.religiousAltar.description, equals('altar religioso'));
        expect(
            SpecialRoom.abandonedDen.description, equals('covil abandonado'));
      });
    });
    ...
    group('SpecialRoom2', () {
      ...
      test('should have correct descriptions', () {
        expect(SpecialRoom2.tortureChamber.description,
            equals('câmara de tortura'));
        expect(SpecialRoom2.ritualChamber.description,
            equals('câmara de rituais'));
        expect(SpecialRoom2.magicalLaboratory.description,
            equals('laboratório mágico'));
    ...
    group('Monster', () {
      ...
      test('should have correct descriptions', () {
        expect(Monster.newMonsterPlusOccupantI.description,
            equals('Novo Monstro + Ocupante I'));
        expect(Monster.occupantIPlusOccupantII.description,
            equals('Ocupante I + Ocupante II'));
        ...
        expect(Monster.newMonsterPlusOccupantII.description,
            equals('Novo Monstro + Ocupante II'));
      });
    });
    ...
    group('SpecialTrap', () {
      ...
      test('should have correct descriptions', () {
        ...
        expect(SpecialTrap.retractableCeiling.description,
            equals('Teto Retrátil'));
        expect(SpecialTrap.secretDoor.description, equals('Porta Secreta'));
        expect(SpecialTrap.alarm.description, equals('Alarme'));
        expect(SpecialTrap.dimensionalPortal.description,
            equals('Portal Dimensional'));
      });
    });
    ...
    group('Treasure', () {
      ...
      test('should have correct descriptions', () {
        ...
        expect(Treasure.copperSilver.description,
            equals('1d6 x 100 PP + 1d6 x 10 PO'));
        expect(
            Treasure.silverGems.description, equals('1d6 x 10 PO + 1d4 Gemas'));
        expect(
            Treasure.specialTreasure.description, equals('Tesouro Especial…'));
    ...
    group('SpecialTreasure', () {
      ...
      test('should have correct descriptions', () {
        expect(SpecialTreasure.rollAgainPlusMagicItem.description,
            equals('Jogue Novamente + Item Mágico'));
        expect(SpecialTreasure.copperSilverGems.description,
            equals('1d6 x 100 PP + 1d6 x 10 PO + 1d4 Gemas'));
        expect(SpecialTreasure.copperSilverGems2.description,
            equals('1d10 x 100 PP + 1d6 x 100 PO + 1d4 Gemas'));
        expect(
            SpecialTreasure.copperSilverGemsValuable.description,
            equals(
                '1d6 x 1.000 PP + 1d6 x 200 PO + 1d6 Gemas + 1d4 Objetos de Valor'));
        expect(SpecialTreasure.copperSilverGemsMagicItem.description,
            equals('1d6 x 1.000 PP + 1d6 x 200 PO + 1d6 Gemas + Item Mágico'));
        expect(SpecialTreasure.rollAgainPlusMagicItem2.description,
            equals('Jogue Novamente + Item Mágico 2'));
      });
    });
    ...
    group('MagicItem', () {
      ...
      test('should have correct descriptions', () {
        ...
        expect(
            MagicItem.any1NotWeapon.description, equals('1 Qualquer não Arma'));
