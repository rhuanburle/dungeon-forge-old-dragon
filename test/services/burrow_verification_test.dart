...
void main() {
  group('Burrow Tables Verification Tests', () {
    ...
    group('Table 4.18 - Tocas Entry Tests', () {
      test(
        'Roll 1: Fenda Profunda no solo com 2d4+2 metros de diâmetro e 3d6+10 metros de profundidade',
        () {
          ...
          expect(
            ...
            matches(
              RegExp(
                r'Fenda Profunda no solo com \d+ metros de diâmetro e \d+ metros de profundidade',
              ),
            ),
          );
      ...
      test(
        'Roll 2: Fenda Rasa no solo com 1d4+1 metros de diâmetro e 1d6+3 metros de profundidade',
        () {
          ...
          expect(
            ...
            matches(
              RegExp(
                r'Fenda Rasa no solo com \d+ metros de diâmetro e \d+ metros de profundidade',
              ),
            ),
          );
      ...
      test(
        'Roll 3: Colmeia Gigante em fenda na rocha com 1d10x3 células hexagonais',
        () {
          ...
          expect(
            ...
            matches(
              RegExp(
                r'Colmeia Gigante em fenda na rocha com \d+ células hexagonais',
              ),
            ),
          );
      ...
      test(
        'Roll 4: Colmeia Gigante em túnel escavado com 1d10x3 células hexagonais',
        () {
          ...
          expect(
            ...
            matches(
              RegExp(
                r'Colmeia Gigante em túnel escavado com \d+ células hexagonais',
              ),
            ),
          );
      ...
      test(
        'Roll 5: Toca Escavada na terra com 2d4 metros de diâmetro e 2d6+2 metros de profundidade',
        () {
          ...
          expect(
            ...
            matches(
              RegExp(
                r'Toca Escavada na terra com \d+ metros de diâmetro e \d+ metros de profundidade',
              ),
            ),
          );
      ...
      test('Roll 6: Formigueiro Gigante com 1d4+1 metros de altura', () {
        ...
        expect(
          burrow.entry,
          matches(RegExp(r'Formigueiro Gigante com \d+ metros de altura')),
        );
    ...
    group('Table 4.19 - Ocupantes das Tocas Tests', () {
      test('Fenda Profunda - Roll 1: Aranha Caçadora Gigante (1d2)', () {
        ...
        expect(
          burrow.occupant,
          matches(RegExp(r'Aranha Caçadora Gigante \(\d+\)')),
        );
      ...
      test('Fenda Rasa - Roll 1: Aranha Camufladora Gigante (1d4)', () {
        ...
        expect(
          burrow.occupant,
          matches(RegExp(r'Aranha Camufladora Gigante \(\d+\)')),
        );
      ...
      test('Toca Escavada - Roll 1: Aranha Peluda Gigante (1d2)', () {
        ...
        expect(
          burrow.occupant,
          matches(RegExp(r'Aranha Peluda Gigante \(\d+\)')),
        );
      ...
      test('Formigueiro Gigante - Roll 1: Besouro de Fogo Gigante (1d4)', () {
        ...
        expect(
          burrow.occupant,
          matches(RegExp(r'Besouro de Fogo Gigante \(\d+\)')),
        );
      ...
      test('Roll 1: Nada Encontrado', () {
        ...
        expect(
          ...
          anyOf(
            ...
            matches(
              RegExp(
                r'\d+ Relíquias \(tabela 4\.6\) \+ \d+ Objetos \(tabela 4\.8\)',
              ),
            ),
            matches(
              RegExp(
                r'\d+ Relíquias \(tabela 4\.6\) \+ \d+ Objetos \(tabela 4\.8\) \+ \d+ Ossadas \(tabela 4\.11\)',
              ),
            ),
            matches(
              RegExp(
                r'\d+ Relíquias \(tabela 4\.6\) \+ 1 Item Mágico \(tabela 4\.12\)',
              ),
            ),
          ),
        );
