...
void main() {
  group('Detailed Cave Tables Tests', () {
    ...
    group('Table 4.16 - Detailed Cave Inhabitant Tests', () {
      test(
        'should generate correct inhabitant for roll 1 (1d10 Fungo Pigmeu)',
        () {
          final cave = service.generateCaveWithRoll(1);
      ...
      test(
        'should generate correct inhabitant for roll 2 (1d6 Aranha Negra Gigante)',
        () {
          final cave = service.generateCaveWithRoll(2);
      ...
      test(
        'should generate correct inhabitant for roll 3 (1d2 Urso Pardo)',
        () {
          final cave = service.generateCaveWithRoll(3);
      ...
      test(
        'should generate correct inhabitant for roll 4 (1d6 Urso-Coruja)',
        () {
          final cave = service.generateCaveWithRoll(4);
    ...
    group('Table 4.17 - Detailed Chamber Type Tests', () {
      test(
        'should generate correct chamber type for roll 1 (Câmara larga)',
        () {
          final cave = service.generateCaveWithDetailedRolls(1, 1, 2, 1);
          print(
            'Testing chamber type roll 1 - Chamber: ${cave.chamberDetails}',
          );
          ...
          expect(
            cave.chamberDetails!,
            matches(RegExp(r'Câmara larga \(\d+ x \d+ metros\)')),
          );
        },
      );

      test(
        'should generate correct chamber type for roll 2 (Câmara pequena)',
        () {
          final cave = service.generateCaveWithDetailedRolls(1, 2, 2, 2);
          print(
            'Testing chamber type roll 2 - Chamber: ${cave.chamberDetails}',
          );
          ...
          expect(
            cave.chamberDetails!,
            matches(RegExp(r'Câmara pequena \(\d+ x \d+ metros\)')),
          );
        },
      );

      test(
        'should generate correct chamber type for roll 3 (Corredor esquerda)',
        () {
          final cave = service.generateCaveWithDetailedRolls(1, 3, 2, 3);
          print(
            'Testing chamber type roll 3 - Chamber: ${cave.chamberDetails}',
          );
          expect(
            cave.chamberDetails!,
      ...
      test(
        'should generate correct chamber type for roll 4 (Corredor direita)',
        () {
          final cave = service.generateCaveWithDetailedRolls(1, 4, 4, 4);
          print(
            'Testing chamber type roll 4 - Chamber: ${cave.chamberDetails}',
          );
          expect(
            cave.chamberDetails!,
      ...
      test(
        'should generate correct chamber type for roll 5 (Túnel estreito)',
        () {
          final cave = service.generateCaveWithDetailedRolls(1, 5, 5, 5);
          print(
            'Testing chamber type roll 5 - Chamber: ${cave.chamberDetails}',
          );
          ...
          expect(
            cave.chamberDetails!,
            matches(RegExp(r'Túnel estreito \(\d+ cm de largura\)')),
          );
        },
      );
      ...
      test('should generate correct chamber type for roll 6 (Túnel baixo)', () {
        ...
        expect(
          cave.chamberDetails!,
          matches(RegExp(r'Túnel baixo \(\d+ cm de altura\)')),
        );
      });
    });
    ...
    group('Table 4.17 - Detailed Chamber Content Tests', () {
      test(
        'should generate correct content for roll 1 (Jogue na coluna Especial)',
        () {
      ...
      test(
        'should generate correct content for roll 4 (Encontro no subterrâneo)',
        () {
          final cave = service.generateCaveWithDetailedRolls(1, 4, 4, 4);
    ...
    group('Table 4.17 - Detailed Chamber Special Tests', () {
      test('should generate correct special for roll 1 (Fosso para baixo)', () {
        ...
        expect(
          cave.chamberDetails!,
          matches(
            RegExp(r'Fosso para baixo \(\d+ metros e \d+ metros de largura\)'),
          ),
        );
      });
      ...
      test('should generate correct special for roll 2 (Túnel para cima)', () {
        ...
        expect(
          cave.chamberDetails!,
          matches(
            RegExp(r'Túnel para cima \(\d+ metros e \d+ metros de diâmetro\)'),
          ),
        );
      });
      ...
      test(
        'should generate correct special for roll 4 (Riacho subterrâneo)',
        () {
          final cave = service.generateCaveWithDetailedRolls(1, 4, 4, 4);
          ...
          expect(
            cave.chamberDetails!,
            matches(RegExp(r'Riacho subterrâneo \(\d+ metros de largura\)')),
          );
        },
      );
      ...
      test('should generate correct special for roll 5 (Lago subterrâneo)', () {
        ...
        expect(
          cave.chamberDetails!,
          matches(RegExp(r'Lago subterrâneo \(\d+ metros de profundidade\)')),
        );
      });
      ...
      test('should generate correct special for roll 6 (Encruzilhada)', () {
        ...
        expect(
          cave.chamberDetails!,
          matches(RegExp(r'Encruzilhada para \d+ novas direções')),
        );
      });
    });
  });
