  ...
  group('DungeonTable9_1', () {
    ...
    group('specific column tests', () {
      ...
      test('column 10 - occupant I should return correct values', () {
        ...
        expect(
            DungeonTable9_1.getColumn10(6), equals(DungeonOccupant.skeletons));
        expect(
            DungeonTable9_1.getColumn10(7), equals(DungeonOccupant.skeletons));
        ...
        expect(
            DungeonTable9_1.getColumn10(10), equals(DungeonOccupant.bugbears));
        expect(
            DungeonTable9_1.getColumn10(11), equals(DungeonOccupant.bugbears));
      ...
      test('column 11 - occupant II should return correct values', () {
        ...
        expect(
            DungeonTable9_1.getColumn11(4), equals(DungeonOccupant.grayOoze));
        expect(
            DungeonTable9_1.getColumn11(5), equals(DungeonOccupant.grayOoze));
        ...
        expect(
            DungeonTable9_1.getColumn11(8), equals(DungeonOccupant.giantRats));
        expect(
            DungeonTable9_1.getColumn11(9), equals(DungeonOccupant.giantRats));
        expect(DungeonTable9_1.getColumn11(10),
            equals(DungeonOccupant.pygmyFungi));
        expect(DungeonTable9_1.getColumn11(11),
            equals(DungeonOccupant.pygmyFungi));
        expect(
            DungeonTable9_1.getColumn11(12), equals(DungeonOccupant.lizardMen));
      });

      test('column 12 - leader should return correct values', () {
        expect(
            DungeonTable9_1.getColumn12(2), equals(DungeonOccupant.hobgoblin));
        expect(
            DungeonTable9_1.getColumn12(3), equals(DungeonOccupant.hobgoblin));
        expect(DungeonTable9_1.getColumn12(4),
            equals(DungeonOccupant.gelatinousCube));
        expect(DungeonTable9_1.getColumn12(5),
            equals(DungeonOccupant.gelatinousCube));
        ...
        expect(DungeonTable9_1.getColumn12(10),
            equals(DungeonOccupant.necromancer));
        expect(DungeonTable9_1.getColumn12(11),
            equals(DungeonOccupant.necromancer));
