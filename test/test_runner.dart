...
import 'models/dto/dungeon_generation_dto_test.dart'
    as dungeon_generation_dto_test;
import 'mappers/dungeon_mapper_test.dart' as dungeon_mapper_test;
import 'services/dungeon_generator_regression_test.dart'
    as dungeon_generator_regression_test;
import 'integration/dungeon_generator_integration_test.dart'
    as dungeon_generator_integration_test;
...
void runPerformanceTests() {
  group('Performance Tests', () {
    test('should generate dungeons within reasonable time', () {
      ...
      expect(averageTimeMs, lessThan(100),
          reason: 'Generation should be under 100ms on average');
    });
  });
}
